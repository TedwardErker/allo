...
generate_formula <- function(model_table, gen, sp, cit, clim, het) {
    ...
    generate_formula <- function(gen, sp, cit, clim, het, family) {
        ...
        ##     b0 ~ 1
        ##     b0 ~ (1 \vert Species)
        ##     b0 ~ (1 \vert Genus / Species)
        ##     b0 ~ (1 \vert Genus / Species)
        ##     b0 ~ (1 \vert City)
        ##     b0 ~ t2(Precip, GDD) +  (1 \vert City)
        ##     b0 ~ t2(Precip, GDD, k = ) +  (1 \vert City)
        ##     b0 ~ (1 \vert City)
        ##     b0 ~ t2(Precip, GDD) +  (1 \vert City)
        ##     b0 ~ (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ Precip * GDD +  (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ Precip * GDD +  (1 \vert City) + (1 \vert Genus / Species)
        ##     b0 ~ Precip * GDD +  (1 \vert City) + (1 \vert Genus / Species)
