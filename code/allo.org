...
m_generated_singleSpecies_multipleLocations_homo <- brm(form, chains = 4, cores = 2, data = dt, prior = nlprior,  control = list(adapt_delta = 0.9))
...
~City (Number of levels: 4)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.53      0.37     0.18     1.64       1162 1.00
sd(b1_Intercept)     1.07      0.92     0.18     3.43       1367 1.00
sd(b2_Intercept)     0.17      0.15     0.02     0.61        935 1.00

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.32      0.28     0.72     1.90       1081 1.00
b1_Intercept     1.96      0.53     0.83     3.02       1459 1.00
b2_Intercept     0.95      0.11     0.73     1.19        803 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     2.86      0.21     2.49     3.31       4000 1.00

Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample
is a crude measure of effective sample size, and Rhat is the potential
scale reduction factor on split chains (at convergence, Rhat = 1).
Warning message:
There were 55 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help.
...
#+begin_src R
  model_fram_homo <- update(m_generated_singleSpecies_multipleLocations_homo, newdata = fram)
#+end_src
