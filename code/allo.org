...
Should the beta's be normal or gamma?  I think I could do normal with
pretty tight sd?
...
| parameter |   mu |  sd | beta (of gamma) | alpha (of gamma) |
|-----------+------+-----+-----------------+------------------|
| \beta_0   |    3 | 1.5 |   3/2.25 = 1.33 |                2 |
| \beta_1   |  1.5 |  .3 |           16.66 |                5 |
| \beta_2   | 1.25 |  .1 |             125 |             12.5 |
| \beta_3   | 1.05 |  .1 |             105 |             10.5 |
...
a <- marginal_effects(prior_mod, spaghetti = T, nsamples = 500, theme = theme_gray())
#+end_src
