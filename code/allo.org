...
:
: sent 342 bytes  received 54 bytes  158.40 bytes/sec
: total size is 1213  speedup is 3.06
...
:
: sent 16502 bytes  received 7372480 bytes  2111137.71 bytes/sec
: total size is 7498109  speedup is 1.01
: You have new mail in /var/mail/erker
