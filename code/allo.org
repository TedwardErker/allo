...
#+begin_src R
  ...
  m_simple <- brm(form, chains = 2, cores = 2, data = smpl, init_r = 1)
#+end_src
...
Gradient evaluation took 0.001086 seconds
1000 transitions using 10 leapfrog steps per transition would take 10.86 seconds.
Adjust your expectations accordingly!
...
Gradient evaluation took 0.001051 seconds
1000 transitions using 10 leapfrog steps per transition would take 10.51 seconds.
Adjust your expectations accordingly!
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 15.1599 seconds (Warm-up)
               8.50206 seconds (Sampling)
               23.662 seconds (Total)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 21.3216 seconds (Warm-up)
               6.95393 seconds (Sampling)
               28.2755 seconds (Total)
#+end_example

#+begin_src R
summary(m_sup_smpl, digits = 3)
#+end_src
...
Formula: y ~ 1
         sigma ~ x - 1
   Data: smpl (Number of observations: 500)
Samples: 2 chains, each with iter = 2000; warmup = 1000; thin = 1;
         total post-warmup samples = 2000

Population-Level Effects:
          Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
Intercept    -0.49      0.21    -0.89    -0.10        466 1.00
sigma_x       0.09      0.00     0.09     0.09       2000 1.00
...
#+begin_src R
my_sigma_x <- c(.1,.3,.6,.9,1.2,1.5)
stan_sigma_x <- c(.02617, .05202, .076358, .0879, .1132786, .116)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 17.2654 seconds (Warm-up)
               16.2416 seconds (Sampling)
               33.507 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 21.2624 seconds (Warm-up)
               17.5166 seconds (Sampling)
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.38      0.16     1.13     1.75        583 1.00
b1_Intercept     1.74      0.14     1.46     2.01        651 1.00
b2_Intercept     0.99      0.04     0.92     1.07        734 1.00
sigma_x          0.04      0.00     0.03     0.04       2000 1.00
