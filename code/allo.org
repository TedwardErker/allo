  ...
  library(bayesplot)
    ...
    family <- "Gamma"
      ...
      nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
                   ...
                   prior(gamma(20, 1), class = "shape"),
                   prior(normal(0, .3), class = "sd", nlpar = "b0", group = "Genus"),
                   prior(normal(0, .15), class = "sd", nlpar = "b0", group = "Genus:Species"),
...
#+RESULTS:
: Error: unexpected ')' in "    b0_form <- formula(b0 ~ 1 | Genus/Species))"
: Error: The following priors do not correspond to any model parameter:
: sd_Genus__b0 ~ normal(0, 0.3)
: sd_Genus:Species__b0 ~ normal(0, 0.15)
