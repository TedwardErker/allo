...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma_FullData_full_singlepane_CityEffects.png
  ...
  dd <- mod$data %>%
      ...
      ggplot(me2) +
          geom_ribbon(aes(x = AGE, ymin = estimate__ - se__, ymax = estimate__ + se__, fill = City), alpha = .3, fill = "gray") +
          geom_point(data = dd, aes(x = AGE, y = DBH, color = City), alpha = 1, size = .5) +
          geom_line(aes(x = AGE, y = estimate__, color = City), size = 1) +
          scale_x_continuous(limits = c(0,150)) +
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma_FullData_full_singlepane_CityEffects.png]]
