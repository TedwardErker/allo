...
: 
: sent 185 bytes  received 60 bytes  98.00 bytes/sec
: total size is 1700  speedup is 6.94
: You have new mail in /var/mail/erker
...
: 
: sent 5912 bytes  received 122665 bytes  51430.80 bytes/sec
: total size is 137142  speedup is 1.07
...
#+begin_src R :exports results :results graphics :file ../figs/genus_test.png
  ggplot(dd) + 
  geom_line(aes(x = AGE, y = Estimate, color = Genus))
#+end_src
