...
:
: sent 872 bytes  received 66 bytes  375.20 bytes/sec
: total size is 2593  speedup is 2.76
...
#+RESULTS:
: erker@krusty's password:
: receiving file list ... rsync: link_stat "/home/erker/allo/models/genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma.rds" failed: No such file or directory (2)
: done
:
