...
\[
\tau_1 \sim Normal(.07, .04)
\]

\[
\tau_2 \sim Normal(.07, .04)
\]

\[
\tau_3 \sim Normal(.05, .03)
\]
...
#+begin_src R :tangle climate_b3.R
    ...
    nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
                 ...
                 prior(normal(0.01, 0.005), nlpar = "b3", coef = "precip"),
                 prior(normal(0.005, 0.005), nlpar = "b3", coef = "gdd:precip"))
...
: climate_b3.R
:
: sent 792 bytes  received 42 bytes  333.60 bytes/sec
: total size is 1767  speedup is 2.12
: You have new mail in /var/mail/erker
