...
#+begin_src R
  ...
  model_lg_climate <- brm(form, chains = 2, cores = 2, data = lg_clim, prior = nlprior, init_r = 0)
...
"          form <- bf(DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)),
                     b0 ~ t2(Precip, HDD) + (1 | City) + ,"
Error: unexpected ',' in "                     b1 ~ t2(Precip, HDD) + (1 | City),"
Error: unexpected ',' in "                     b2 ~ t2(Precip, HDD) + (1 | City),"
Error: unexpected ')' in "                     nl = T)"
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipHDD_1)     0.21      0.44     0.00     1.18        754 1.00
sds(b0_t2PrecipHDD_2)     0.38      1.01     0.00     2.83        261 1.00
sds(b0_t2PrecipHDD_3)     0.41      0.81     0.00     2.83        615 1.00

Group-Level Effects:
~City (Number of levels: 14)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.39      0.15     0.19     0.75        639 1.00

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept         2.25      0.51     1.53     3.55        863 1.00
b0_t2PrecipHDD_1     0.20      0.11     0.06     0.46       1147 1.00
b0_t2PrecipHDD_2     0.29      0.12     0.11     0.58        945 1.00
b0_t2PrecipHDD_3     0.46      0.19     0.17     0.92        836 1.00
b1_Intercept         1.03      0.15     0.69     1.30       1102 1.00
b2_Intercept         0.92      0.03     0.86     0.99       1334 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     9.54      0.17     9.21     9.89       2000 1.00
