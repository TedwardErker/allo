...
#+begin_src R
          form <- bf(y ~ 100*b0 * (1 - exp(-b1 * x ^ b2)),
                     b0 ~ 1,
                     b1 ~ 1,
                     b2 ~ 1,
                     nl = T)

  nlprior <- c(prior(normal(1, 2), nlpar = "b0"),
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 35.5917 seconds (Warm-up)
               27.7119 seconds (Sampling)
               63.3037 seconds (Total)

Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 37.0216 seconds (Warm-up)
               28.9971 seconds (Sampling)
               66.0187 seconds (Total)
#+end_example
...
b0_Intercept    45.84     49.68   -14.08   109.78          1 8.65
b1_Intercept    -0.71      0.85    -2.52     0.01          1 2.06
b2_Intercept     0.63      0.42     0.15     1.16          1 7.28

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.45      0.49     4.59     6.41          2 1.27
...
Looks good. parameter estimates recovered.
