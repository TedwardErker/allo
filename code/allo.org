...
*** A script to turn model_table into a script to fit
...
#+begin_src R
    ...
    generate_prior <- function(model_table, genus, species, cities, climate, hetero) {

      nlprior <- c(prior(gamma(4, 3), nlpar = "b0",lb = 0),
                     prior(gamma(5, 1), nlpar = "b1", lb = 0),
                     prior(gamma(4, 3), nlpar = "b2",lb = 0))
  if("many" %in% c(genus, species, cities) {
