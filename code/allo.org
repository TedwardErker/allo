...
#+begin_src R :exports results :results graphics :file ../figs/predictions_dbh_bySpeciesCity_wData_more.png :height 2000 :width 1200 :bg transparent
    teal <- "#00ffff"
    blue <- "#1500ff"
    purple <- "#aa00ff"
    purplered <- "#ff00ff"
  red <- "#ff0000"
    ...
    darkergreen <- "#04e600"
      ...
      ggplot(me2) +
          ...
          geom_line(data = predictions_apprange_sub, aes(x = AGE, y = predicted_dbh), size = 1.5, color = blue) +
            theme_solarized(light = F, base_size = 18) +
      theme(axis.text = element_text(size = 18, color = "#839496"),
            rect = element_rect(fill = "transparent"),
            panel.background = element_rect(fill = "transparent"),
