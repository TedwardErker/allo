...
: allo_functions.R
:
: sent 634 bytes  received 60 bytes  198.29 bytes/sec
: total size is 1786  speedup is 2.57
: You have new mail in /var/mail/erker
...
:
: sent 649 bytes  received 42 bytes  106.31 bytes/sec
: total size is 1134  speedup is 1.64
: You have new mail in /var/mail/erker
...
: receiving file list ... done
:
: sent 16 bytes  received 139 bytes  34.44 bytes/sec
: total size is 60401329  speedup is 389685.99
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipHDD_1)     0.43      0.25     0.03     0.80          7 1.31
sds(b0_t2PrecipHDD_2)     0.43      0.26     0.03     0.81          6 1.37
sds(b0_t2PrecipHDD_3)     0.43      0.24     0.03     0.80          7 1.27

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.79      0.32     0.32     1.57         60  1.03
sd(b1_Intercept)     0.41      0.19     0.21     0.81          3  2.57
sd(b2_Intercept)     0.25      0.27     0.09     0.85          3 10.68

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.37      0.40     0.00     1.29          9  1.23
sd(b1_Intercept)     0.19      0.27     0.00     0.79          3  4.57
sd(b2_Intercept)     0.26      0.46     0.00     1.29          3 13.98

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     1.09      0.29     0.46     1.65         22  1.07
sd(b1_Intercept)     0.41      0.28     0.17     1.02          3  4.96
sd(b2_Intercept)     0.30      0.38     0.08     1.16          3 15.83

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept         1.88      0.56     0.84     2.74          4 1.84
b0_t2PrecipHDD_1     0.73      0.27     0.33     1.18          5 1.52
b0_t2PrecipHDD_2     0.51      0.22     0.18     0.91          9 1.20
b0_t2PrecipHDD_3     0.69      0.26     0.29     1.09          6 1.40
b1_Intercept         1.04      0.16     0.78     1.33          5 1.46
b2_Intercept         0.89      0.05     0.78     0.97          9 1.20

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sigma     8.28      3.20     1.12     9.89          3 39.01
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 2645 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_smooths_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  marginal_smooths(mod, smooths = "s(AGE)", ask = F)
#+end_src

#+RESULTS:
[[file:../figs/marginal_smooths_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]
