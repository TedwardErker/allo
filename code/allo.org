...
|-------+---------+--------+--------------------+--------------------+--------------------------------------------+----------------------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+----------------+----------------------------------------------------------------------------------------------------|
| none  | single  | single | none               | no                 | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ 1                                                               | b1 ~ 1                                            | b2 ~ 1                                            |                | bf(y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)),  b0 ~ 1,  b1 ~ 1,  b2 ~ 1, nl = T)                  |
| none  | single  | single | none               | yes                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ 1                                                               | b1 ~ 1                                            | b2 ~ 1                                            | sigma ~ AGE -1 | bf(y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)),  sigma ~ AGE - 1, b0 ~ 1,  b1 ~ 1,  b2 ~ 1, nl = T) |
...
*** A single script to fit all the models
