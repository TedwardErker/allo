...
:
: sent 188 bytes  received 54 bytes  32.27 bytes/sec
: total size is 1227  speedup is 5.07
...
:
: sent 24896 bytes  received 22362068 bytes  2356522.53 bytes/sec
: total size is 22466780  speedup is 1.00
: You have new mail in /var/mail/erker
...
~Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.20      0.12     0.01     0.46       1398 1.01
sd(b1_Intercept)     0.37      0.12     0.21     0.66          8 1.27
sd(b2_Intercept)     0.76      0.21     0.43     1.25       1058 1.01
sd(b3_Intercept)     0.18      0.04     0.11     0.27         11 1.16

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     2.84      0.09     2.66     3.02       6000 1.02
b1_Intercept     0.99      0.11     0.80     1.24          7 1.30
b2_Intercept     1.17      0.16     0.87     1.50        939 1.01
b3_Intercept     1.21      0.05     1.11     1.30          8 1.26

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     9.90      0.19     9.52    10.28       6000 1.00
...
2: There were 21 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
...
:
: sent 441 bytes  received 54 bytes  76.15 bytes/sec
...
#nlprior <- c(nlprior, prior(gamma(100, 10), class = "shape"))
#+end_src
...
#+begin_src R
  ...
  get_prior(form, d, fam)

  #mod <- brm(form, chains = 6, cores = 6, data = d, init_r = .3, prior = nlprior, iter = 10000, family = fam)
  mod <- brm(form, chains = 1, cores = 1, data = d, init_r = 5, prior = nlprior, iter = 500, family = fam)
...
:
: sent 441 bytes  received 54 bytes  198.00 bytes/sec
: total size is 1217  speedup is 2.46
