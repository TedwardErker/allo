...
Gradient evaluation took 0.048466 seconds
1000 transitions using 10 leapfrog steps per transition would take 484.66 seconds.
Adjust your expectations accordingly!
...
Gradient evaluation took 0.060313 seconds
1000 transitions using 10 leapfrog steps per transition would take 603.13 seconds.
Adjust your expectations accordingly!
...
Iteration: 300 / 300 [100%]  (Sampling)
 ...
 Elapsed Time: 192.42 seconds (Warm-up)
               75.1138 seconds (Sampling)
               267.533 seconds (Total)

Iteration: 300 / 300 [100%]  (Sampling)

 Elapsed Time: 195.289 seconds (Warm-up)
               76.1773 seconds (Sampling)
               271.466 seconds (Total)
#+end_example

#+begin_src R :tangle no :exports results :results graphics :file ../figs/inter_marginaleffects.png
 marginal_effects(prior_mod, spaghetti = T, nsamples = 100, theme = theme_gray())
#+end_src
