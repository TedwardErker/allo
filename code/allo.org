...
|-----------+------+-----+------------------+-----------------|
| \beta_0   |    3 | 1.5 |                4 |   3/2.25 = 1.33 |
| \beta_1   |  1.5 |  .3 |               25 |           16.66 |
| \beta_2   | 1.25 |  .1 |           156.25 |             125 |
| \beta_3   | 1.05 |  .1 |           110.25 |             105 |
...
#+begin_src R
  ...
  family <- "Gamma"
    ...
    nlprior <- c(prior(gamma(4,  1.33), nlpar = "b0",lb = 0),
               ...
               prior(gamma(156.25, 125), nlpar = "b2", lb = 0),
               prior(gamma(110.25, 105), nlpar = "b3",lb = 0),
               prior(gamma(20, 1), class = "shape"))
...
#+begin_src R :tangle no :exports results :results graphics :file ../figs/genus_none_species_single_cities_single_climate_none_hetero_no_family_gamma_prior_marginaleffects1.png
