...
Population-Level Effects:
                Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma_Intercept     2.26      0.15     1.98     2.56       1814 1.00
b0_Intercept        1.06      0.05     0.97     1.18        701 1.00
b1_Intercept        1.70      0.58     0.76     2.98        652 1.00
b2_Intercept        1.14      0.11     0.93     1.37        552 1.00
sigma_x             0.01      0.00     0.00     0.01       2000 1.00
...
model {
  ...
  target += gamma_lpdf(b_b2 | 1, 2)
    - 1 * gamma_lccdf(0 | 1, 2);
  target += student_t_lpdf(temp_sigma_Intercept | 3, 0, 10);
  // likelihood including all constants
  if (!prior_only) {
    target += normal_lpdf(Y | mu, sigma);
  }
