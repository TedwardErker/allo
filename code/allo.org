...
*** TODO COMMENT intermediate complexity   THINK HARD ABOUT REASONABLE VARIABILITY FOR EACH PARAMETER.  SET Intelligent priors!  some need to be much smaller than others
:PROPERTIES:
  ...
  library(bayesplot)
    ...
    family <- "Gamma"
      ...
      nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
                   ...
                   prior(gamma(20, 1), class = "shape"),
                   prior(normal(0, .5), class = "sd", nlpar = "b0", group = "Genus"),
                   prior(normal(0, .25), class = "sd", nlpar = "b0", group = "Genus:Species"),
                   prior(normal(0, .13), class = "sd", nlpar = "b1", group = "Genus"),
                   prior(normal(0, .06), class = "sd", nlpar = "b1", group = "Genus:Species"),
                   prior(normal(0, .06), class = "sd", nlpar = "b2", group = "Genus"),
                   prior(normal(0, .03), class = "sd", nlpar = "b2", group = "Genus:Species"),
                   prior(normal(0, .06), class = "sd", nlpar = "b3", group = "Genus"),
                   prior(normal(0, .03), class = "sd", nlpar = "b3", group = "Genus:Species"))
    ...
    prior_mod <-  brm(form,
                 ...
                 family = Gamma("identity"),
               sample_prior = "only",
                 chains = 2, cores = 2, init_r = .3, iter = 500, control = list(adapt_delta = .9))
...
Gradient evaluation took 0.031906 seconds
1000 transitions using 10 leapfrog steps per transition would take 319.06 seconds.
Adjust your expectations accordingly!
...
Gradient evaluation took 0.039568 seconds
1000 transitions using 10 leapfrog steps per transition would take 395.68 seconds.
Adjust your expectations accordingly!
...
Iteration: 500 / 500 [100%]  (Sampling)
 ...
 Elapsed Time: 208.661 seconds (Warm-up)
               118.326 seconds (Sampling)
               326.988 seconds (Total)

Iteration: 450 / 500 [ 90%]  (Sampling)
Iteration: 500 / 500 [100%]  (Sampling)

 Elapsed Time: 234.814 seconds (Warm-up)
               116.706 seconds (Sampling)
               351.52 seconds (Total)

Warning messages:
1: There were 5 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help. See
