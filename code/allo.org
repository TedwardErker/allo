...
#+begin_src R
    ...
    model_lg_climate_GenSp_hetero_smooth <- brm(form, chains = 2, cores = 2, data = lg_clim, prior = nlprior, init_r = .3)
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipHDD_1)     0.35      0.21     0.03     0.84        995 1.00
sds(b0_t2PrecipHDD_2)     0.36      0.20     0.03     0.80        813 1.00
sds(b0_t2PrecipHDD_3)     0.36      0.21     0.04     0.80       1018 1.00

Group-Level Effects:
~City (Number of levels: 14)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     2.36      0.89     1.14     4.65        221 1.02
sd(b1_Intercept)     0.69      0.23     0.39     1.28        186 1.01
sd(b2_Intercept)     0.16      0.04     0.11     0.25        100 1.04

~Genus (Number of levels: 7)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.11      0.10     0.00     0.37        239 1.00
sd(b1_Intercept)     0.13      0.05     0.06     0.27        331 1.01
sd(b2_Intercept)     0.10      0.04     0.03     0.20        218 1.01

~Genus:SpCode (Number of levels: 13)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.18      0.06     0.10     0.34        185 1.03
sd(b1_Intercept)     0.04      0.03     0.00     0.12        153 1.03
sd(b2_Intercept)     0.04      0.02     0.01     0.10        150 1.01

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept         2.94      0.68     1.68     4.40        264 1.00
b0_t2PrecipHDD_1     1.49      0.57     0.53     2.76        286 1.01
b0_t2PrecipHDD_2     0.94      0.44     0.28     1.98        326 1.01
b0_t2PrecipHDD_3     1.13      0.50     0.31     2.27        285 1.02
b1_Intercept         0.89      0.23     0.51     1.42        119 1.00
b2_Intercept         0.99      0.06     0.86     1.11         76 1.04
sigma_AGE            0.08      0.00     0.07     0.08       2000 1.00
