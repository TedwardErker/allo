...
**** generate data
#+begin_src R
  k <- 5  # number locations
  l <- 7  # number of species
  expect_nkl <- 20
  n <- k * l * expect_nkl
...
#+RESULTS:
:
: [1] 36 32 65  5  4 25 24 36  9  2  5 18  5  4  2  1 40 34  4  8 24  8 13 24 13
: [26]  6 20 70  6 70 21  5 54  2  5
...
#+begin_src R :exports results :results graphics :file ../figs/pairs_m_generated_multipleSpecies_multipleLocations_homo.png
pairs(m_generated_multipleSpecies_multipleLocations_homo)
#+end_src
