...
: allo_functions.R
:
: sent 340 bytes  received 90 bytes  122.86 bytes/sec
: total size is 5258  speedup is 12.23
...
*** genus: many;  species: many; cities: many; climate: b0; hetero: no; family: gaussian
:PROPERTIES:
...
*** genus: many;  species: many; cities: many; climate: b0; hetero: no; family: Gamma
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0_hetero_no.R
:END:
**** libraries and functions
