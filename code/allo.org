...
#+begin_src R
    ...
    x1 <- colorRampPalette(c("brown","red","violet"), space = "rgb", interpolate = "spline")(100)
    x2 <- colorRampPalette(c("brown","red","violet"), space = "rgb", interpolate = "spline")(100)
    ...
    cols <- sapply(1:length(x1), function(i) {colorRampPalette(c(x1[i], x2[i], x3[i], x4[i],x5[i]), space = "rgb",interpolate = "spline")(100) })
