...
|-------+----------------------------------------------+------------------------------------------------------|
|     1 | No varying parameters                        | DBH ~ b0 + 100 * b1 * (1 - exp(-(b2/100) * AGE^(b3))) |
|       |                                              | b0 ~ 1                                               |
|       |                                              | b1 ~ 1                                               |
|       |                                              | b2 ~ 1                                               |
|       |                                              | b3 ~ 1                                               |
|     2 | parameters vary by city                      |                                                      |
|       |                                              |                                                      |
|       |                                              |                                                      |
|       |                                              |                                                      |
|       |                                              |                                                      |
|     3 | parameters vary by genus and species         |                                                      |
|     4 | asympotote (\beta_1) varies by climate            |                                                      |
|     5 | growth rate (\beta_3) varies by climate           |                                                      |
|     6 | parameters vary by city, genus, and species. |                                                      |
|       | Growth rate varies by climate.               |                                                      |
|     7 | parameters vary by city, genus, and species  |                                                      |
