...
df <- data.frame(AGE, DBH)
  ...
  mod <- brm(form, chains = 2, cores = 2, data = df, init_r = .3, prior = nlprior, iter = 500, family = family)
#+end_src
...
#+RESULTS:
[[file:../figs/ttest.png]]
*** CAN I DO IDENTITY LINK WITH GAMMA FAMILY?????
...
*** genus: many;  species: many; cities: many; climate: none; hetero: no; family: gamma
:PROPERTIES:
...
*** why are the precip and hdd effects backwards??  look at data?
