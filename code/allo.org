...
: 
: sent 679 bytes  received 54 bytes  293.20 bytes/sec
: total size is 1700  speedup is 2.32
: You have new mail in /var/mail/erker
...
#+RESULTS:
: 
: sh-3.2$ sh-3.2$ sh-3.2$ sh-3.2$ erker@krusty's password: 
: receiving file list ... done
: genus_many_species_many_cities_notB1_many_climate_b3linint_hetero_no_family_Gamma_FullData_marginaleffects_methodfitted_observedconditions.rds
: 
: sent 38 bytes  received 944631 bytes  269905.43 bytes/sec
: total size is 955325  speedup is 1.01
...
me_genus <-readRDS("~/git/allo/models/genus_many_species_many_cities_notB1_many_climate_b3linint_hetero_no_family_Gamma_FullData_marginaleffects_methodfitted.rds")
#+end_src

#+RESULTS:

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma_FullData_full_singlepane_GenusEffects_ribbons_test.png :width 1000 :height 800 :res 170 :bg transparent
  me2 <- me_genus$AGE
...
#                geom_ribbon(aes(x = AGE, ymin = estimate__ - se__, ymax = estimate__ + se__, group = Genus), fill = "gray", alpha = .1) +
                geom_line(aes(x = AGE, y = estimate__, color = Genus, group = interaction(Species, City)), size = .7, alpha = .5, color = blue) +
   #             geom_point(data = dd, aes(x = AGE, y = DBH, color = as.numeric(City)), alpha = 1, size = .2) +
                scale_x_continuous(limits = c(0,150)) +
                scale_y_continuous("DBH") +
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma_FullData_full_singlepane_GenusEffects_ribbons_test.png]]
