...
*** TODO Get new climate data.  Growing degree days and Precip. Make plots
...
#+begin_src R :exports results :results graphics :file ../figs/hue_pal_simpler.png
  ...
  orange <- "#cb4b16"
         ...
         x1 <- colorRampPalette(c(orange,orange, r, r, r), space = "rgb", interpolate = "spline")(50)
         x2 <- colorRampPalette(c(blue,  yellow), space = "rgb", interpolate = "spline")(50)
         x3 <- colorRampPalette(c(blue, cyan,green), space = "rgb", interpolate = "spline")(50)

         cols <- sapply(1:length(x1), function(i) {colorRampPalette(c(x1[i], x2[i], x3[i]), space = "rgb",interpolate = "spline")(50) })
...
This is the problem....what is causing it!!!???!!?!?  it must be how
i'm calcuatling distance.....
#+begin_src R :exports results :results graphics :file ../figs/tests.png
ggplot(precip_gdd_closest, aes(x = gdd_col, y = precip_col)) + geom_point()
#ggplot(cols, aes(x = gdd_col, y = precip_col)) + geom_point()
#ggplot(dn, aes(x = gdd, y = precip)) + geom_point()
...
#+begin_src R :exports results :results graphics :file ../figs/gdd_precip_points_colored.png
  ggplot(data = ddn, aes(x = gdd, y = precip / 100, color = value)) +
...
theme(axis.text = element_text(size = 18, color = "white"))
#+end_src
...
#+begin_src R :exports results :results graphics :file ../figs/gdd_precip_cont_simple.png :width 600 :height 400
