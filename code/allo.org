...
#+name: model_table
| genus | species | cities | climate | hetero | data                                       | b0                                                                   | b1                                                | b2                                                | sigma          | prior |   |   |   |
|-------+---------+--------+---------+--------+--------------------------------------------+----------------------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+----------------+-------+---+---+---|
| none  | single  | single | none    | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ 1                                                               | b1 ~ 1                                            | b2 ~ 1                                            |                |       |   |   |   |
| none  | single  | single | none    | yes    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ 1                                                               | b1 ~ 1                                            | b2 ~ 1                                            | sigma ~ AGE -1 |       |   |   |   |
| none  | many    | single | none    | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ (1 \vert Species)                                               | b1 ~ (1 \vert Species)                            | b2 ~ (1 \vert Species)                            |                |       |   |   |   |
| many  | many    | single | none    | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ (1 \vert Genus / Species)                                       | b1 ~ (1 \vert Genus / Species)                    | b2 ~ (1 \vert Genus / Species)                    |                |       |   |   |   |
| many  | many    | single | none    | yes    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ (1 \vert Genus / Species)                                       | b1 ~ (1 \vert Genus / Species)                    | b2 ~ (1 \vert Genus / Species)                    | sigma ~ AGE -1 |       |   |   |   |
| none  | single  | many   | none    | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ (1 \vert Cities)                                                | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             |                |       |   |   |   |
| none  | single  | many   | b0      | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities)                             | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             |                |       |   |   |   |
| none  | single  | many   | none    | yes    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ (1 \vert Cities)                                                | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |       |   |   |   |
| none  | single  | many   | b0      | yes    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities)                             | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |       |   |   |   |
| many  | many    | many   | b0      | no     | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) |                |       |   |   |   |
| many  | many    | many   | b0      | yes    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) | sigma ~ AGE -1 |       |   |   |   |



      nlprior <- c(prior(gamma(4, 3), nlpar = "b0",lb = 0), prior(gamma(5, 1), nlpar = "b1", lb = 0), prior(gamma(4, 3), nlpar = "b2",lb = 0),
...
|-------+---------+--------+--------------------+--------------------+--------------------------------------------+----------------------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+----------------+---------|
| many  | many    | many   | on \beta_0         | yes                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) | sigma ~ AGE -1 |         |
|       |         |        |                    |                    | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Genus / Species)                    | b2 ~ (1 \vert Genus / Species)                    | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ 1                                            | b2 ~ 1                                            | sigma ~ AGE -1 |         |
...
#+begin_src R
      ...
      generate_formula(model_table, "none", "single", "single", "none", "no")
        ...
        generate_prior("none", "single", "many", "b0")
...
#+begin_example
[[1]]
y ~ 100 * b0 * (1 - exp(-(b1/100) * x^b2))
attr(,"nl")
[1] TRUE
<environment: 0x7fe74a60a950>
              prior class coef group resp dpar nlpar     bound
1       gamma(4, 3)     b                         b0 <lower=0>
2       gamma(5, 1)     b                         b1 <lower=0>
3       gamma(4, 3)     b                         b2 <lower=0>
4    cauchy(0, 0.1)    sd                         b0
5    cauchy(0, 0.1)    sd                         b1
6    cauchy(0, 0.1)    sd                         b2
7 normal(0.3, 0.25)   sds                         b0
#+end_example
...
#+begin_src R :exports results :results graphics :file ../figs/test_gen_none_sp_single_cities_single_climate_none_hetero_no.png
...
Iteration: 500 / 500 [100%]  (Sampling)
 ...
 Elapsed Time: 7.68354 seconds (Warm-up)
               7.84655 seconds (Sampling)
               15.5301 seconds (Total)
#+end_example
...
b0_Intercept     1.23      0.03     1.17     1.30        133 1.00
b1_Intercept     2.78      0.30     2.25     3.43         89 1.00
b2_Intercept     0.90      0.04     0.83     0.98         90 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     4.59      0.29     4.07     5.14        125 1.01
...
#+begin_src R
    ...
    model_lg_climate_GenSp_hetero <- brm(form, chains = 2, cores = 2, data = lg_clim, prior = nlprior, init_r = .3)

#+end_src

#+begin_src R
model_lg_climate_GenSp_hetero
#+end_src
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipHDD_1)     5.62     12.38     0.01    42.28          5 1.63
sds(b0_t2PrecipHDD_2)     0.70      2.61     0.00     6.55        162 1.01
sds(b0_t2PrecipHDD_3)     0.32      0.76     0.00     2.49        401 1.00

Group-Level Effects:
~City (Number of levels: 14)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     1.81      1.07     0.02     4.18          6 1.33
sd(b1_Intercept)     0.72      0.22     0.38     1.27         41 1.05
sd(b2_Intercept)     0.15      0.03     0.11     0.22        240 1.02

~Genus (Number of levels: 7)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.11      0.09     0.00     0.34        145 1.01
sd(b1_Intercept)     0.14      0.06     0.06     0.29        216 1.01
sd(b2_Intercept)     0.11      0.04     0.05     0.21        224 1.01

~Genus:SpCode (Number of levels: 13)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.17      0.05     0.10     0.28        131 1.02
sd(b1_Intercept)     0.03      0.02     0.00     0.09        145 1.03
sd(b2_Intercept)     0.03      0.02     0.01     0.08         96 1.03

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept         3.10      0.69     1.82     4.49         63 1.02
b0_t2PrecipHDD_1     1.52      0.53     0.54     2.62        121 1.02
b0_t2PrecipHDD_2     0.84      0.39     0.26     1.75         84 1.02
b0_t2PrecipHDD_3     1.21      0.48     0.44     2.30        249 1.01
b1_Intercept         0.92      0.22     0.56     1.41        141 1.02
b2_Intercept         1.00      0.06     0.87     1.11         97 1.01
sigma_AGE            0.08      0.00     0.07     0.08       1777 1.00
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 25 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example

#+begin_src R :exports results :results graphics :file ../figs/pp_check_lg_climate_GenSp_hetero.png
pp_check(model_lg_climate_GenSp_hetero) + xlim(c(-15,100))
#+end_src
...
marginal_effects(model_lg_climate_GenSp_hetero, effects = "AGE:Precip")
#+end_src
...
marginal_effects(model_lg_climate_GenSp_hetero, effects = "AGE:HDD")
#+end_src
...
marginal_effects(model_lg_climate_GenSp_hetero, effects = "Precip:HDD", surface = T)
#+end_src
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_lg_climate_GenSp_hetero_Points.png
  ...
  me <- marginal_effects(model_lg_climate_GenSp_hetero, effects = "AGE", conditions = conditions, re_formula = NA)
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_lg_climate_GenSp_hetero_Points_hddprecip.png
  ...
  me <- marginal_effects(model_lg_climate_GenSp_hetero, effects = "AGE", conditions = conditions, re_formula = NULL)
