...
sent 84869 bytes  received 798 bytes  34266.80 bytes/sec
total size is 88566  speedup is 1.03
You have new mail in /var/mail/erker
erker@krusty's password:
building file list ... done
age_dbh_testing.rds

sent 36481 bytes  received 366 bytes  14738.80 bytes/sec
total size is 37868  speedup is 1.03
#+end_example
...
df <- data.frame(AGE, DBH)
  ...
  mod <- brm(form, chains = 2, cores = 2, data = df, init_r = .3, prior = nlprior, iter = 300, family = family)
#+end_src
...
Iteration: 300 / 300 [100%]  (Sampling)
 ...
 Elapsed Time: 4.46588 seconds (Warm-up)
               0.692581 seconds (Sampling)
               5.15846 seconds (Total)
...
Iteration: 300 / 300 [100%]  (Sampling)
 ...
 Elapsed Time: 6.47648 seconds (Warm-up)
               0.713819 seconds (Sampling)
               7.1903 seconds (Total)

Warning messages:
1: There were 92 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help. See
http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
2: Examine the pairs() plot to diagnose sampling problems
#+end_example

*** TODO all the models  model_table  MAKE SURE MY PRIORS ARE CORRECT.
...
|-------+---------+--------+--------------------+--------------------+------------------------------------------------+--------------------------------------------------------------------+-------------------------------------------------+-------------------------------------------------+----------------+---------|
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species) | b1 ~ (1 \vert City) + (1 \vert Genus / Species) | b2 ~ (1 \vert City) + (1 \vert Genus / Species) | sigma ~ AGE -1 |         |
|       |         |        |                    |                    | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species) | b1 ~ (1 \vert City)                             | b2 ~ (1 \vert City)                             | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species) | b1 ~ (1 \vert Genus / Species)                  | b2 ~ (1 \vert Genus / Species)                  | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, GDD) +  (1 \vert City) + (1 \vert Genus / Species) | b1 ~ 1                                          | b2 ~ 1                                          | sigma ~ AGE -1 |         |
...
: allo_functions.R
:
: sent 273 bytes  received 90 bytes  38.21 bytes/sec
: total size is 5414  speedup is 14.91
: You have new mail in /var/mail/erker
...
:
: sent 524 bytes  received 54 bytes  88.92 bytes/sec
: total size is 1122  speedup is 1.94
...
Formula: DBH ~ b0 * (1 - exp(-(b1) * AGE^b2))
         b0 ~ 1
         b1 ~ 1
         b2 ~ 1
...
b0_Intercept     4.96      0.06     4.84     5.08        786 1.00
b1_Intercept     0.29      0.00     0.28     0.29        802 1.00
b2_Intercept     0.48      0.01     0.46     0.50        735 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     6.10      0.11     5.89     6.31       1429 1.00
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.45      0.10     1.29     1.68        845 1.00
b1_Intercept     1.42      0.06     1.31     1.54       1063 1.00
b2_Intercept     0.96      0.02     0.91     1.00        901 1.00
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     0.05      0.00     0.05     0.05        330 1.00
b1_Intercept    28.55      0.39    27.79    29.30        720 1.00
b2_Intercept     0.48      0.01     0.46     0.50        348 1.00
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.90      0.31     1.38     2.56        974 1.01
b1_Intercept     1.38      0.21     1.01     1.82       1026 1.01
b2_Intercept     0.87      0.01     0.85     0.89       1098 1.01
...
b0_Intercept        1.89      0.19     1.60     2.28        246 1.00
b1_Intercept        1.30      0.10     1.11     1.48        317 1.00
b2_Intercept        0.89      0.01     0.86     0.92        260 1.01
...
~Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.80      0.24     0.42     1.37       3375 1.00
sd(b1_Intercept)     0.68      0.18     0.40     1.10       4825 1.00
sd(b2_Intercept)     0.23      0.04     0.17     0.32       5139 1.00

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.54      0.20     1.18     1.99       4399 1.00
b1_Intercept     1.39      0.16     1.09     1.73       6513 1.00
b2_Intercept     0.98      0.05     0.88     1.08       4862 1.00
...
*** genus: none;  species: many; cities: single; climate: none; hetero: no; family: gamma
:PROPERTIES:
...
:
: sent 662 bytes  received 42 bytes  281.60 bytes/sec
: total size is 1128  speedup is 1.60
...
: receiving file list ... done
:
: sent 16 bytes  received 156 bytes  18.11 bytes/sec
: total size is 17134696  speedup is 99620.33
...
#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_none_species_many_cities_single_climate_none_hetero_no_family_Gamma.png
  pairs(mod)
#+end_src
...
~Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.45      0.08     0.32     0.64       1309 1.00
sd(b1_Intercept)     0.06      0.02     0.04     0.10        834 1.01
sd(b2_Intercept)     0.07      0.02     0.04     0.12        917 1.01

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     4.70      0.10     4.50     4.92       1000 1.00
b1_Intercept     0.29      0.01     0.26     0.32        617 1.02
b2_Intercept     0.54      0.02     0.50     0.57       1486 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     7.41      0.14     7.15     7.68       4000 1.00
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_none_species_many_cities_single_climate_none_hetero_no_family_Gamma.png
  plot(mod, ask = F)
#+end_src
...
#+RESULTS:
| gamma(1, 0.2)  | b  |   |   |   |   | b0 | <lower=0> |
| gamma(1, 0.2)  | b  |   |   |   |   | b1 | <lower=0> |
| gamma(1, 0.2)  | b  |   |   |   |   | b2 | <lower=0> |
| cauchy(0, 0.1) | sd |   |   |   |   | b0 |           |
| cauchy(0, 0.1) | sd |   |   |   |   | b1 |           |
| cauchy(0, 0.1) | sd |   |   |   |   | b2 |           |
...
:
: sent 647 bytes  received 42 bytes  196.86 bytes/sec
: total size is 1120  speedup is 1.63
: You have new mail in /var/mail/erker
...
:
: sent 38 bytes  received 38435850 bytes  3660560.76 bytes/sec
: total size is 38560683  speedup is 1.00
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.57      0.22     0.29     1.12          5 1.56
sd(b1_Intercept)     0.05      0.01     0.03     0.08         36 1.04
sd(b2_Intercept)     0.07      0.02     0.04     0.12          8 1.24

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.48      0.38     0.01     1.24          9 1.22
sd(b1_Intercept)     0.05      0.02     0.01     0.11         26 1.06
sd(b2_Intercept)     0.08      0.03     0.01     0.14         20 1.08

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.43      0.21     0.15     0.93         80 1.05
sd(b1_Intercept)     0.02      0.01     0.00     0.05         10 1.18
sd(b2_Intercept)     0.03      0.02     0.00     0.09         13 1.12

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     5.15      0.32     4.61     5.91          8 1.24
b1_Intercept     0.27      0.02     0.23     0.32         87 1.03
b2_Intercept     0.49      0.04     0.41     0.56          9 1.20

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     9.42      0.18     9.06     9.79       9000 1.02
...
2: There were 22 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_none_species_many_cities_single_climate_none_hetero_no_family_Gamma.png :width 1200 :height 1000
...
*** TODO genus: many;  species: many; cities: many; climate: b0linint; hetero: no; family: gaussian
:PROPERTIES:
  :header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.R
:END:
**** libraries and functions
#+begin_src R
  library(dplyr)
...
#+BEGIN_SRC sh :session a :results verbatim
  ...
  rsync -avz genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.R erker@krusty:~/allo/code/
...
: erker@krusty's password:
: building file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.R
:
...
#+BEGIN_SRC sh :session b :results raw
  ssh krusty
  cd allo/code
  nohup R CMD BATCH genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.R &
  exit
#+END_SRC
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.rds ~/git/allo/models/
#+END_SRC

#+RESULTS:
: erker@krusty's password:
: receiving file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.rds
:
...
:END:
#+begin_src R
mod <- readRDS("~/git/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.rds")
#+end_src

#+RESULTS:


#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  pairs(mod)
#+end_src

#+RESULTS:
[[file:../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]
...
#+begin_example
 Family: gaussian
  Links: mu = identity; sigma = identity
Formula: DBH ~ 100 * b0linint * (1 - exp(-(b1/100) * AGE^b2))
         b0linint ~ t2(Precip, CDD) + (1 | City) + (1 | Genus/Species)
         b1 ~ (1 | City) + (1 | Genus/Species)
         b2 ~ (1 | City) + (1 | Genus/Species)
   Data: d (Number of observations: 5548)
Samples: 6 chains, each with iter = 2000; warmup = 1000; thin = 1;
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0linint_t2PrecipCDD_1)     0.48      0.40     0.01     1.08          4 2.50
sds(b0linint_t2PrecipCDD_2)     0.47      0.39     0.00     1.04          4 2.10
sds(b0linint_t2PrecipCDD_3)     0.58      0.52     0.01     1.30          3 3.24

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0linint_Intercept)     0.93      0.36     0.30     1.66          5 1.59
sd(b1_Intercept)     0.75      0.38     0.16     1.30          3 3.16
sd(b2_Intercept)     0.50      0.50     0.10     2.06          6 1.90

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0linint_Intercept)     0.46      0.42     0.01     1.02          5 1.84
sd(b1_Intercept)     0.64      0.53     0.01     1.42          4 2.12
sd(b2_Intercept)     0.41      0.41     0.01     1.00          4 3.41

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0linint_Intercept)     0.97      0.31     0.41     1.57          5 1.67
sd(b1_Intercept)     0.56      0.30     0.12     1.09          6 1.62
sd(b2_Intercept)     0.45      0.43     0.06     1.14          3 4.71

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0linint_Intercept         1.40      0.46     0.69     2.56          4 1.98
b0linint_t2PrecipCDD_1     0.84      0.38     0.20     1.49          4 2.45
b0linint_t2PrecipCDD_2     0.68      0.34     0.15     1.23          4 2.72
b0linint_t2PrecipCDD_3     0.96      0.48     0.21     1.89          3 3.04
b1_Intercept         0.98      0.22     0.64     1.48          6 1.47
b2_Intercept         0.86      0.08     0.76     1.04          4 1.78
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  plot(mod, ask = F)
#+end_src

#+RESULTS:
[[file:../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  marginal_effects(mod, effects = "AGE:CDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  marginal_effects(mod, effects = "Precip:CDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png :width 800
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]

#+begin_src R :exports results :results graphics :file ../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png
  pp_check(mod)
#+end_src

#+RESULTS:
[[file:../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_gaussian.png]]

*** TODO genus: many;  species: many; cities: many; climate: b0linint; hetero: no; family: Gamma
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.R
:END:
**** libraries and functions
#+begin_src R
  library(dplyr)
...
#+BEGIN_SRC sh :session a :results verbatim
  ...
  rsync -avz genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.R erker@krusty:~/allo/code/
...
: building file list ... done
:
: sent 148 bytes  received 20 bytes  67.20 bytes/sec
: total size is 1124  speedup is 6.69
...
#+BEGIN_SRC sh :session b :results raw
  ssh krusty
  cd allo/code
  nohup R CMD BATCH genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.R &
  exit
#+END_SRC
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.rds ~/git/allo/models/
#+END_SRC

#+RESULTS:
: erker@krusty's password:
: receiving file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.rds
:
: sent 32978 bytes  received 65335855 bytes  3352247.85 bytes/sec
: total size is 65456067  speedup is 1.00
...
:END:
#+begin_src R
mod_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma <- readRDS("~/git/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.rds")
mod <- mod_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma
#+end_src

#+RESULTS:


#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
  pairs(mod)
#+end_src

#+RESULTS:
[[file:../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]
...
Formula: DBH ~ b0 * (1 - exp(-(b1) * AGE^b2))
         ...
         b2 ~ (1 | City) + (1 | Genus/Species)
   Data: d (Number of observations: 5548)
Samples: 6 chains, each with iter = 6000; warmup = 3000; thin = 1;
         total post-warmup samples = 18000

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.52      0.16     0.29     0.91         26 1.06
sd(b1_Intercept)     0.05      0.01     0.03     0.07        106 1.02
sd(b2_Intercept)     0.09      0.02     0.06     0.13       8005 1.00

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.47      0.39     0.01     1.22         23 1.08
sd(b1_Intercept)     0.04      0.01     0.01     0.07         13 1.13
sd(b2_Intercept)     0.06      0.03     0.01     0.12         14 1.12

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.52      0.24     0.19     1.01        467 1.03
sd(b1_Intercept)     0.01      0.01     0.00     0.04       2541 1.00
sd(b2_Intercept)     0.04      0.02     0.00     0.09         12 1.14

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      5.56      0.35     4.86     6.24          8 1.26
b0_Precip         0.67      0.36     0.06     1.44      11466 1.00
b0_GDD            0.30      0.16     0.01     0.60          6 1.38
b0_Precip:GDD     0.31      0.21     0.02     0.80         38 1.04
b1_Intercept      0.27      0.02     0.23     0.30         72 1.03
b2_Intercept      0.46      0.04     0.39     0.54          9 1.19

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     9.43      0.18     9.08     9.78      18000 1.01
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 107 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example



#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
  plot(mod, ask = F)
#+end_src

#+RESULTS:
[[file:../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
  marginal_effects(mod, effects = "AGE:GDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
precip.gdd <-   marginal_effects(mod, effects = "Precip:GDD", surface = T)
precip.gdd
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma_wCities.png
  plot(precip.gdd)[[1]] +
...
#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma_wCities.png]]




#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png :width 1000 :height 100
    cond <- expand.grid(Species = unique(mod$data$Species),  City = unique(mod$data$City))
    cond <- left_join(cond, unique(select(mod$data, Species, Genus)))
  ...
  me2 <- me$AGE  %>% mutate(GDDPrecip = (GDD - min(GDD)) * (Precip - min(Precip)),
  ...
  dd <- mod$data %>%
      ...
      ggplot(me2) +
          geom_line(aes(x = AGE, y = estimate__, color = GDDPrecip), size = 2) +
          geom_ribbon(aes(x = AGE, ymin = estimate__ - se__, ymax = estimate__ + se__), alpha = .3, fill = "blue") +
          geom_point(data = filter(dd, Species == "List"), aes(x = AGE, y = DBH), alpha = .3, size = .5) +
          facet_grid(Species~City)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]

#+begin_src R :exports results :results graphics :file ../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png
   pp_check(mod) + xlim(c(-30,250))
#+end_src

#+RESULTS:
[[file:../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_no_family_Gamma.png]]




*** genus: many;  species: many; cities: many; climate: b0; hetero: smooth
:PROPERTIES:
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png
  marginal_effects(mod, effects = "AGE:HDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png
  marginal_effects(mod, effects = "Precip:HDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_smooths_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png
  marginal_smooths(mod, smooths = "s(AGE)", ask = F)
#+end_src

#+RESULTS:
[[file:../figs/marginal_smooths_genus_many_species_many_cities_many_climate_b0_hetero_smooth.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0_hetero_smooth.png :width 800
  cond <- data.frame(Species = unique(d$Species))
  me <- marginal_effects(mod, conditions = cond, re_formula = NULL)
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0_hetero_smooth.png]]
...
*** genus: many;  species: many; cities: many; climate: b0linint; hetero: smooth  NO CONVERGE
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.R
:END:
**** libraries and functions
#+begin_src R
  library(dplyr)
...
#+BEGIN_SRC sh :session a :results verbatim
  ...
  rsync -avz genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.R erker@krusty:~/allo/code/
...
: erker@krusty's password:
: building file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.R
:
...
#+BEGIN_SRC sh :session b :results raw
  ssh krusty
  cd allo/code
  nohup R CMD BATCH genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.R &
  exit
#+END_SRC
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.rds ~/git/allo/models/
#+END_SRC

#+RESULTS:
: erker@krusty's password:
: receiving file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.rds
:
...
:END:
#+begin_src R
mod <- readRDS("~/git/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.rds")
#+end_src

#+RESULTS:


#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  pairs(mod)
#+end_src

#+RESULTS:
[[file:../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.52      0.35     0.15     1.13          3  3.81
sd(b1_Intercept)     0.58      0.33     0.24     1.12          3  5.20
sd(b2_Intercept)     0.38      0.35     0.09     0.94          3 16.15

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     1.37      0.49     0.08     2.43         36  1.06
sd(b1_Intercept)     0.40      0.46     0.01     1.26          3  7.66
sd(b2_Intercept)     0.41      0.50     0.01     1.30          3 15.35

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.59      0.31     0.20     1.28          7  1.30
sd(b1_Intercept)     0.53      0.39     0.16     1.13          3  8.84
sd(b2_Intercept)     0.42      0.45     0.06     1.20          3 21.87

Population-Level Effects:
                Estimate Est.Error l-95% CI u-95% CI Eff.Sample   Rhat
sigma_Intercept     1.47      0.92     0.01     2.13          3 117.66
b0_Intercept        1.60      0.60     0.79     2.62          4   1.96
b0_Precip           0.64      0.17     0.30     0.88          7   1.30
b0_GDD              0.63      0.34     0.27     1.19          3   5.43
b0_Precip:GDD       0.66      0.19     0.34     0.97          4   1.71
b1_Intercept        1.09      0.15     0.89     1.38          5   1.51
b2_Intercept        0.86      0.05     0.80     0.97          5   1.48
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  plot(mod, ask = F)
#+end_src

#+RESULTS:
[[file:../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  marginal_effects(mod, effects = "AGE:HDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  marginal_effects(mod, effects = "Precip:HDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png :width 800
  cond <- data.frame(Species = unique(d$Species))
  me <- marginal_effects(mod, conditions = cond, re_formula = NULL)
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]

#+begin_src R :exports results :results graphics :file ../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png
  pp_check(mod)
#+end_src

#+RESULTS:
[[file:../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth.png]]

*** FULL DATA genus: many;  species: many; cities: many; climate: b0linint; hetero: smooth
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.R
:END:
**** libraries and functions
#+begin_src R
  library(dplyr)
...
#+BEGIN_SRC sh :session a :results verbatim
  ...
  rsync -avz genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.R erker@krusty:~/allo/code/
...
: erker@krusty's password:
: building file list ... done
: genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.R
:
...
#+BEGIN_SRC sh :session b :results raw
  ssh krusty
  cd allo/code
  nohup R CMD BATCH genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.R &
  exit
#+END_SRC
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.rds ~/git/allo/models/
#+END_SRC
...
:END:
#+begin_src R
mod <- readRDS("~/git/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.rds")
#+end_src

#+RESULTS:


#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  pairs(mod)
#+end_src

#+RESULTS:
[[file:../figs/pairs_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]
...
#+begin_example
 Family: gaussian
  Links: mu = identity; sigma = log
Formula: DBH ~ 100 * b0 * (1 - exp(-(b1/100) * AGE^b2))
         b0 ~ Precip * HDD + (1 | City) + (1 | Genus/Species)
         b1 ~ (1 | City) + (1 | Genus/Species)
         b2 ~ (1 | City) + (1 | Genus/Species)
         sigma ~ s(AGE)
...
~City (Number of levels: 16)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.73      0.20     0.43     1.17         13  1.15
sd(b1_Intercept)     0.41      0.20     0.21     0.82          3  3.37
sd(b2_Intercept)     0.27      0.36     0.07     1.07          3 18.33

~Genus (Number of levels: 83)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.62      0.77     0.01     2.39          3  5.14
sd(b1_Intercept)     0.57      0.36     0.03     1.27          4  2.55
sd(b2_Intercept)     0.30      0.42     0.01     1.22          3 10.55

~Genus:Species (Number of levels: 161)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.68      0.19     0.27     1.02          4  2.21
sd(b1_Intercept)     0.56      0.33     0.22     1.27          3  5.93
sd(b2_Intercept)     0.42      0.38     0.09     1.25          3 20.55

Population-Level Effects:
                Estimate Est.Error l-95% CI u-95% CI Eff.Sample   Rhat
sigma_Intercept     1.86      0.80     0.08     2.23          3 155.27
b0_Intercept        1.90      0.56     0.82     2.76          4   2.58
b0_Precip           1.07      0.29     0.48     1.70          9   1.23
b0_HDD              0.46      0.32     0.13     1.10          3   3.19
b0_Precip:HDD       0.64      0.25     0.26     0.99          5   1.57
b1_Intercept        1.27      0.21     0.96     1.65          5   1.87
b2_Intercept        0.94      0.06     0.85     1.05          5   1.69
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  plot(mod, ask = F)
#+end_src

#+RESULTS:
[[file:../figs/plot_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  marginal_effects(mod, effects = "AGE:HDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  marginal_effects(mod, effects = "Precip:HDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png :width 800
  cond <- data.frame(Species = unique(d$Species))
  me <- marginal_effects(mod, conditions = cond, re_formula = NULL)
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]

#+begin_src R :exports results :results graphics :file ../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png
  pp_check(mod)
#+end_src

#+RESULTS:
[[file:../figs/pp_check_genus_many_species_many_cities_many_climate_b0linint_hetero_smooth_fulldata.png]]
