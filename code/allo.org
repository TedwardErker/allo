...
:
: sent 601 bytes  received 72 bytes  192.29 bytes/sec
: total size is 2820  speedup is 4.19
: You have new mail in /var/mail/erker
...
:
: sent 46399 bytes  received 42723323 bytes  2759336.90 bytes/sec
: total size is 42898182  speedup is 1.00
: You have new mail in /var/mail/erker
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.47      0.05     0.37     0.58       8000 1.01
sd(b1_Intercept)     0.23      0.04     0.17     0.31         12 1.21
sd(b2_Intercept)     0.16      0.02     0.13     0.19       8000 1.01
sd(b3_Intercept)     0.09      0.01     0.07     0.12         85 1.03

~Genus (Number of levels: 17)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.34      0.09     0.18     0.52       2021 1.02
sd(b1_Intercept)     0.51      0.09     0.31     0.68         12 1.22
sd(b2_Intercept)     0.14      0.03     0.09     0.20       1457 1.01
sd(b3_Intercept)     0.10      0.03     0.03     0.15         11 1.25

~Genus:Species (Number of levels: 24)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.05      0.04     0.00     0.13       4935 1.00
sd(b1_Intercept)     0.06      0.04     0.00     0.16          9 1.34
sd(b2_Intercept)     0.06      0.02     0.02     0.10         52 1.05
sd(b3_Intercept)     0.05      0.01     0.03     0.08       2575 1.01

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      2.52      0.17     2.18     2.86       3969 1.00
b1_Intercept      1.57      0.15     1.30     1.87         47 1.05
b2_Intercept      0.89      0.06     0.77     1.01         54 1.04
b3_Intercept      0.98      0.06     0.87     1.08         37 1.06
b3_precip         0.01      0.01     0.00     0.03       8000 1.00
b3_gdd            0.01      0.01     0.00     0.02       8000 1.01
b3_precip:gdd     0.00      0.00     0.00     0.01         23 1.09

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.84      0.29    14.29    15.40       8000 1.01
...
: Warning message:
: In rgamma(8000L, shape = c(14.3862028262278, 14.760682591648, 14.086845468951,  :
:   NAs produced
