...
#+RESULTS:
#+begin_example
Error in na.fail.default(list(long = c(NA, -170.7136, 145.2428, NA, NA,  :
  missing values in object
Error in (function (classes, fdef, mtable)  :
  unable to find an inherited method for function ‘proj4string<-’ for signature ‘"data.frame", "CRS"’
Error in (function (classes, fdef, mtable)  :
  unable to find an inherited method for function ‘proj4string’ for signature ‘"data.frame"’
Error in apply(gdd.dists, 1, function(x) which(x == min(x))[1]) :
  object 'gdd.dists' not found
Error in `[.data.frame`(gdd, cdd.dists.min, ) :
  object 'cdd.dists.min' not found
Error in dots_values(...) :
...
#+begin_src R
  ...
  green <- c(gdd = 9000, precip = 7000)
  blue <- c(gdd = 2000, precip = 7000)
  orange <-  c(gdd = 2000, precip = 100)
  violet <-  c(gdd = 9000, precip = 100)

  colspace <- expand.grid(precip = seq(100,7000, length.out = 100), gdd = seq(2000,9000, length.out = 100))

  x1 <- colorRampPalette(c("#d55201","red","violet"), space = "rgb", interpolate = "spline")(100)
  x2 <- colorRampPalette(c("#d55201","red","violet"), space = "rgb", interpolate = "spline")(100)
  x3 <- colorRampPalette(c("blue","#96db00","yellow"), space = "rgb", interpolate = "spline")(100)
  x4 <- colorRampPalette(c("#5502ed","#41afab","#25db00"), space = "rgb", interpolate = "spline")(100)
  x5 <- colorRampPalette(c("#5502ed","#41afab","#25db00"), space = "rgb", interpolate = "spline")(100)

  x1 <- colorRampPalette(c("violet","red","orange"), space = "Lab", interpolate = "spline")(100)
  x2 <- colorRampPalette(c("violet","red","orange"), space = "Lab", interpolate = "spline")(100)
  x3 <- colorRampPalette(c("blue","#96db00","yellow"), space = "Lab", interpolate = "spline")(100)
  x4 <- colorRampPalette(c("#5502ed","#41afab","#25db00"), space = "Lab", interpolate = "spline")(100)
  x5 <- colorRampPalette(c("#5502ed","#41afab","#25db00"), space = "Lab", interpolate = "spline")(100)




  cols <- sapply(1:length(x1), function(i) {colorRampPalette(c(x1[i], x2[i], x3[i], x4[i],x5[i]), space = "Lab",interpolate = "spline")(100) })
#+end_src

#+RESULTS:

#+begin_src R :exports results :results graphics :file ../figs/hue_pal.png
  x1 <- colorRampPalette(c("#aa00ff","#ff0000"), space = "Lab", interpolate = "spline")(100)
  x2 <- colorRampPalette(c("#aa00ff","#ffff00"), space = "Lab", interpolate = "spline")(100)
  x3 <- colorRampPalette(c("#1500ff","#1500ff","#00ffff","#00ff00","#00ff00"), space = "Lab", interpolate = "spline")(100)

  cols <- sapply(1:length(x1), function(i) {colorRampPalette(c(x1[i], x2[i],x3[i]), space = "Lab",interpolate = "spline")(100) })
  ...
  ggplot(data = cols, aes( x = gdd, y = precip)) +
