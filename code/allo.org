...
: 
: sent 349 bytes  received 54 bytes  161.20 bytes/sec
: total size is 1231  speedup is 3.05
...
:
: sent 16484 bytes  received 52050 bytes  19581.14 bytes/sec
: total size is 52428  speedup is 0.76
: You have new mail in /var/mail/erker
