...
*** I need to simplify things again!!!!!!!!!!!!!!!!
- subsets of data to make sure things are working.   I'm having issues
  with identifying beta_1 and beta_3.  Extremely strong priors on
  beta_1 informed by the champion trees might be a way out of
  this......  I have to find a few measures and find a way to modify
  the stan code
- each round should have the full check of model making sense, at
  least no problems in the convergence/estimation part.
- I should also check to make sure the types of predictions make sense.
...
:
: sent 897 bytes  received 42 bytes  375.60 bytes/sec
: total size is 2809  speedup is 2.99
...
:
: sent 45608 bytes  received 43641690 bytes  5824973.07 bytes/sec
: total size is 43816208  speedup is 1.00
...
*** I could potentially have b1 vary by species and b3 vary by climate/ city.
*** Full model
