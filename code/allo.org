...
| none  | single  | many   | none    | no     | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ (1 \vert Cities)                                                | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             |                |
| none  | single  | many   | b0      | no     | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities)                             | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             |                |
| none  | single  | many   | none    | yes    | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ (1 \vert Cities)                                                | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |
| none  | single  | many   | b0      | yes    | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities)                             | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |
| many  | many    | many   | b0      | no     | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) |                |
| many  | many    | many   | b0      | yes    | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) | sigma ~ AGE -1 |

#+begin_src sh :session a
rsync -avz ../data/model_table.csv erker@krusty:~/data/model_table.csv
#+end_src
...
|-------+---------+--------+--------------------+--------------------+------------------------------------------------+----------------------------------------------------------------------+---------------------------------------------------+---------------------------------------------------+----------------+---------|
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities) + (1 \vert Genus / Species) | b2 ~ (1 \vert Cities) + (1 \vert Genus / Species) | sigma ~ AGE -1 |         |
|       |         |        |                    |                    | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Cities)                             | b2 ~ (1 \vert Cities)                             | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ (1 \vert Genus / Species)                    | b2 ~ (1 \vert Genus / Species)                    | sigma ~ AGE -1 |         |
| many  | many    | many   | on \beta_0         | yes                | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ t2(Precip, HDD) +  (1 \vert Cities) + (1 \vert Genus / Species) | b1 ~ 1                                            | b2 ~ 1                                            | sigma ~ AGE -1 |         |
...
| allo_functions.R |           |       |          |         |                 |      |           |
|                  |           |       |          |         |                 |      |           |
| sent             | 129       | bytes | received | 60      | bytes           | 75.6 | bytes/sec |
| total            | size      | is    | 1650     | speedup | is              | 8.73 |           |
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.13      0.06     1.03     1.27       1214 1.00
b1_Intercept     1.51      0.11     1.30     1.73       1650 1.00
b2_Intercept     1.05      0.04     0.98     1.12       1046 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma    13.86      0.20    13.49    14.26       2387 1.00
