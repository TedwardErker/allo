...
| \beta_3  intercept    |   .6 | .15 |              16. |       26.666667 |
...
#+begin_src R :tangle genus_species_cities.R
  ...
  nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
               ...
               prior(gamma(44.4, 44.4), nlpar = "b3",lb = 0),
               prior(gamma(20, 1), class = "shape"),
               prior(normal(0, .15), class = "sd", nlpar = "b0", group = "City"),
               prior(normal(0, .03), class = "sd", nlpar = "b1", group = "City"),
               prior(normal(0, .01), class = "sd", nlpar = "b2", group = "City"),
               prior(normal(0, .01), class = "sd", nlpar = "b3", group = "City"),
               prior(normal(0, .15), class = "sd", nlpar = "b0", group = "Genus"),
               prior(normal(0, .03), class = "sd", nlpar = "b0", group = "Genus:Species"),
               prior(normal(0, .07), class = "sd", nlpar = "b1", group = "Genus"),
               prior(normal(0, .04), class = "sd", nlpar = "b1", group = "Genus:Species"),
               prior(normal(0, .04), class = "sd", nlpar = "b2", group = "Genus"),
               prior(normal(0, .02), class = "sd", nlpar = "b2", group = "Genus:Species"),
               prior(normal(0, .04), class = "sd", nlpar = "b3", group = "Genus"),
               prior(normal(0, .02), class = "sd", nlpar = "b3", group = "Genus:Species"))
...
: building file list ... done
:
: sent 93 bytes  received 20 bytes  32.29 bytes/sec
: total size is 2600  speedup is 23.01
...
: total size is 24348180  speedup is 147564.73
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.80      0.13     0.57     1.08         17 1.10
sd(b1_Intercept)     0.23      0.06     0.14     0.35          4 2.04
sd(b2_Intercept)     0.17      0.02     0.13     0.20          9 1.20
sd(b3_Intercept)     0.09      0.01     0.06     0.12         22 1.08

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.37      0.11     0.15     0.59         17 1.11
sd(b1_Intercept)     0.51      0.06     0.40     0.63         60 1.04
sd(b2_Intercept)     0.23      0.04     0.15     0.31          6 1.45
sd(b3_Intercept)     0.13      0.02     0.08     0.18         10 1.17

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.05      0.04     0.00     0.13       1723 1.00
sd(b1_Intercept)     0.11      0.05     0.01     0.20         10 1.18
sd(b2_Intercept)     0.06      0.02     0.01     0.09         10 1.18
sd(b3_Intercept)     0.05      0.02     0.01     0.08         48 1.05

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     2.41      0.26     1.91     2.92        319 1.03
b1_Intercept     1.75      0.17     1.42     2.07         11 1.16
b2_Intercept     0.98      0.07     0.85     1.12        709 1.01
b3_Intercept     1.06      0.04     0.98     1.15        806 1.01

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.78      0.28    14.24    15.32       3000 1.00
...
*** genus: many;  species: many; cities: many; climate: b3linint; hetero: no; family: Gamma  Would need to fix priors!
...
#+begin_src R
  ...
  nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
               ...
               prior(normal(0.01, 0.01), nlpar = "b3", coef = "gdd"),
               prior(normal(0.03, 0.01), nlpar = "b3", coef = "precip"),
               prior(normal(0.025, 0.01), nlpar = "b3", coef = "precip:gdd"))
