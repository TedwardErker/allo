...
darkergreen <- "#04e600"
  ...
  x1 <- colorRampPalette(c(purple,purple,red,red), space = "rgb", interpolate = "spline")(100)
  x2 <- colorRampPalette(c(bluepurplepurple,orange), space = "rgb", interpolate = "spline")(100)
  x3 <- colorRampPalette(c(bluepurple,yellow), space = "rgb", interpolate = "spline")(100)
  x4 <- colorRampPalette(c(blue,blueteal,teal,greenteal,green),space = "rgb", interpolate = "spline")(100)
  x5 <- colorRampPalette(c(blue,blueteal,teal,greenteal,green,green),space = "rgb", interpolate = "spline")(100)

  cols <- sapply(1:length(x1), function(i) {colorRampPalette(c(x1[i], x2[i],x3[i],x4[i],x5[i]), space = "rgb",interpolate = "spline")(100) })

  colspace <- expand.grid(precip_col = seq(100,7000, length.out = 100), gdd_col = seq(2000,9000, length.out = 100))
