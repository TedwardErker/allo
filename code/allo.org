...
#+begin_src R
  ...
  model_multipleSpecies_nestedGenus_multipleCities_homo <- update(m_generated_multipleSpecies_multipleLocations_homo, newdata = dm, cores = 2, chains = 4, control = list(adapt_delta = .9, max_treedepth = 15))
