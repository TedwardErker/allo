...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.00798 seconds (Warm-up)
               1.36136 seconds (Sampling)
               6.36935 seconds (Total)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 28.4501 seconds (Warm-up)
               18.9572 seconds (Sampling)
               47.4073 seconds (Total)
#+end_example
...
Population-Level Effects:
          Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
Intercept     0.58      0.34    -0.13     1.21        275 1.00
sigma_x       0.06      0.00     0.06     0.07       1696 1.00
...
qplot(sqrt(my_sigma_x), stan_sigma_x, d)
#+end_src
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.57487 seconds (Warm-up)
               1.66635 seconds (Sampling)
               3.24122 seconds (Total)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.39124 seconds (Warm-up)
               1.29105 seconds (Sampling)
               2.68229 seconds (Total)


SAMPLING FOR MODEL 'simple' NOW (CHAIN 3).
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.33081, but must be > 0!  (in 'model54b4740ffb71_simple' at line 29)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.43805 seconds (Warm-up)
               1.2473 seconds (Sampling)
               2.68535 seconds (Total)


SAMPLING FOR MODEL 'simple' NOW (CHAIN 4).
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.45058 seconds (Warm-up)
               1.45041 seconds (Sampling)
               2.90099 seconds (Total)
#+end_example
...
#          m <- brm(form, chains = 2, cores = 2, data = dt, prior = nlprior, init_r = 1)
code <- make_stancode(form, dt, prior = nlprior)
print(code)
#+end_src
...
Fix the stan code
#+BEGIN_SRC stan :tangle singleSpeciesLocation_hetero_fixed.stan
// generated with brms 2.3.1
functions {
}
data {
...
#+begin_src R
m_fixed <- stan("singleSpeciesLocation_hetero_fixed.stan", data = make_standata(form, dt, prior = nlprior))
m_fixed
#+end_src
...
SAMPLING FOR MODEL 'singleSpeciesLocation_hetero' NOW (CHAIN 1).
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.38729 seconds (Warm-up)
               4.78712 seconds (Sampling)
               10.1744 seconds (Total)


SAMPLING FOR MODEL 'singleSpeciesLocation_hetero' NOW (CHAIN 2).
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.38415 seconds (Warm-up)
               5.58909 seconds (Sampling)
               10.9732 seconds (Total)


SAMPLING FOR MODEL 'singleSpeciesLocation_hetero' NOW (CHAIN 3).
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.16986 seconds (Warm-up)
               5.81384 seconds (Sampling)
               10.9837 seconds (Total)


SAMPLING FOR MODEL 'singleSpeciesLocation_hetero' NOW (CHAIN 4).
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.25627 seconds (Warm-up)
               4.86805 seconds (Sampling)
               10.1243 seconds (Total)
Inference for Stan model: singleSpeciesLocation_hetero.
4 chains, each with iter=2000; warmup=1000; thin=1;
post-warmup draws per chain=1000, total post-warmup draws=4000.

             mean se_mean   sd   2.5%    25%    50%    75%  97.5% n_eff Rhat
b_b0[1]      1.27    0.00 0.06   1.17   1.23   1.26   1.30   1.39  1629    1
b_b1[1]      2.05    0.00 0.09   1.88   2.00   2.05   2.11   2.24  2113    1
b_b2[1]      0.97    0.00 0.02   0.92   0.95   0.97   0.98   1.01  1666    1
b_sigma[1]   0.06    0.00 0.01   0.05   0.06   0.06   0.07   0.08  2191    1
lp__       -87.60    0.05 1.64 -91.79 -88.41 -87.23 -86.38 -85.59  1170    1

Samples were drawn using NUTS(diag_e) at Thu Aug  2 12:30:05 2018.
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_1.png
cond <- data.frame("1" = 1)
  me <-   marginal_effects(m_fixed, points = T, condistions = cond)
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_pts.png
  me <-   marginal_effects(m, points = T)
  ggplot() + geom_line(data = me$x, aes(x = x, y = estimate__)) +
    geom_ribbon(data = me$x, alpha = .2, aes(x = x, ymin = estimate__ - se__, ymax = estimate__ + se__)) +
...
#+begin_src R
model_fram_ftcollins_hetero <- stan("singleSpeciesLocation_hetero.stan", data = make_standata(form, select(fram_ftcollins,AGE,DBH), prior = nlprior), init_r = 1)
#+end_src
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.3319, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -25.9362, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[31] is 0, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -13.0551, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.87259, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -13.653, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -14.2944, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.3028, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -8.35824, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.18054, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -4.06363, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -10.4979, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -23.0038, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.5418, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -21.8643, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -21.36, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -9.66092, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.873594, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -26.3525, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -18.657, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -9.51785, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -6.54803, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.2575, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -6.99159, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.60059, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.9325, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.56517, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -17.2458, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -8.88828, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -7.08619, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -21.9178, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.33709, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -8.72329, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.9463, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -16.4627, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -25.681, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -20.1938, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.01529, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -16.3344, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.6543, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -26.6332, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.3227, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -6.28212, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -14.4753, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -25.648, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -17.1528, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.0201, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -26.1135, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -25.943, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -26.8871, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.1574, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -10.566, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.5788, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -20.5613, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.4263, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -19.3758, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.4983, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.6623, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.7467, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.4866, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.00639, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.9397, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.338401, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.7334, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -27.7804, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -18.6767, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -15.3294, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -4.61424, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -23.9618, but must be > 0!  (in 'model54b4f982a67_singleSpeciesLocation_hetero' at line 49)
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.39      0.44     0.89     2.56        400 1.00
b1_Intercept     0.85      0.21     0.46     1.30        795 1.00
b2_Intercept     1.14      0.13     0.92     1.43        466 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.70      0.74     4.45     7.35       1010 1.00
