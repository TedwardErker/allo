...
*** TODO COMMENT intermediate complexity
:PROPERTIES:
...
library(bayesplot)
  ...
  family <- "Gamma"
    ...
    nlprior <- c(prior(gamma(4, 1.33), nlpar = "b0",lb = 0),
                 ...
                 prior(gamma(20, 1), class = "shape"),
                 prior(gamma(5,10), class = "sd", nlpar = "b0"),
                 prior(gamma(2,10), class = "sd", nlpar = "b1"),
                 prior(gamma(2,10), class = "sd", nlpar = "b2"),
                 prior(gamma(2,10), class = "sd", nlpar = "b3"))
...
Gradient evaluation took 0.038055 seconds
1000 transitions using 10 leapfrog steps per transition would take 380.55 seconds.
Adjust your expectations accordingly!
...
Gradient evaluation took 0.041861 seconds
1000 transitions using 10 leapfrog steps per transition would take 418.61 seconds.
Adjust your expectations accordingly!
...
Iteration: 500 / 500 [100%]  (Sampling)
 ...
 Elapsed Time: 279.112 seconds (Warm-up)
               221.339 seconds (Sampling)
               500.451 seconds (Total)

Iteration: 450 / 500 [ 90%]  (Sampling)
Iteration: 500 / 500 [100%]  (Sampling)

 Elapsed Time: 393.786 seconds (Warm-up)
               167.5 seconds (Sampling)
               561.286 seconds (Total)

Warning messages:
1: There were 271 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help. See
