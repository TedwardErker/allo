...
| model_table.csv |           |       |          |         |       |       |           |
|                 |           |       |          |         |       |       |           |
| sent            | 170       | bytes | received | 72      | bytes |  96.8 | bytes/sec |
| total           | size      | is    | 3709     | speedup | is    | 15.33 |           |
...
*** genus: many;  species: many; cities: many; climate: b0linint; hetero: no
:PROPERTIES:
...
:
: sent 38 bytes  received 30050331 bytes  1397691.58 bytes/sec
: total size is 30189254  speedup is 1.00
: You have new mail in /var/mail/erker
...
:
: sent 664 bytes  received 42 bytes  282.40 bytes/sec
: total size is 1144  speedup is 1.62
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0linint_hetero_linear.rds ~/git/allo/models/
#+END_SRC
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_linear.png
  marginal_effects(mod, effects = "AGE:HDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_linear.png]]
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_linear.png
  marginal_effects(mod, effects = "Precip:HDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipHDD_genus_many_species_many_cities_many_climate_b0linint_hetero_linear.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0linint_hetero_linear.png :width 800
  cond <- data.frame(Species = unique(d$Species))
  me <- marginal_effects(mod, conditions = cond, re_formula = NULL)
