...
#+begin_src R :exports results :results graphics :file ../figs/hue_pal_simpler.png
  ...
  orange <- "#cb4b16"
         ...
         x2 <- colorRampPalette(c(orange,  r), space = "rgb", interpolate = "spline")(50)
         x3 <- colorRampPalette(c(blue,  yellow), space = "rgb", interpolate = "spline")(50)
         x4 <- colorRampPalette(c(blue, cyan,green), space = "rgb", interpolate = "spline")(50)
         x5 <- colorRampPalette(c(blue, cyan,green), space = "rgb", interpolate = "spline")(50)
