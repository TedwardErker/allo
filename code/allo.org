...
:
: sent 38 bytes  received 29991829 bytes  2607988.43 bytes/sec
: total size is 30128274  speedup is 1.00
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.55      0.17     0.30     0.95         17 1.09
sd(b1_Intercept)     0.05      0.01     0.03     0.08         26 1.06
sd(b2_Intercept)     0.08      0.02     0.04     0.13          9 1.23

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.46      0.39     0.01     1.24          8 1.27
sd(b1_Intercept)     0.05      0.02     0.01     0.10         15 1.12
sd(b2_Intercept)     0.08      0.03     0.01     0.14         13 1.14

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.45      0.21     0.16     0.93         35 1.10
sd(b1_Intercept)     0.02      0.01     0.00     0.05         10 1.19
sd(b2_Intercept)     0.03      0.02     0.00     0.08         11 1.21

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      5.27      0.38     4.64     6.08          5 1.45
b0_Precip         0.52      0.41     0.01     1.43          7 1.33
b0_GDD            0.15      0.16     0.00     0.52          4 2.12
b0_Precip:GDD     0.23      0.18     0.01     0.67         17 1.09
b1_Intercept      0.27      0.02     0.23     0.32        112 1.03
b2_Intercept      0.49      0.04     0.41     0.56          8 1.27

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     9.42      0.18     9.07     9.78       6000 1.02
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 17 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
