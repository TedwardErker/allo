...
a 1.176e+02  2.114e+01   5.565 1.51e-07 ***
b 1.731e-02  2.299e-03   7.527 8.66e-12 ***
c 9.914e-01  8.754e-02  11.326  < 2e-16 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 7.267 on 126 degrees of freedom

Number of iterations to convergence: 9
Achieved convergence tolerance: 7.897e-06
#+end_example
...
#          form <- bf(y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)),
          form <- bf(y ~ b0 * (1 - exp(-b1 * x ^ b2)),
                     b0 ~ 1,
                     b1 ~ 1,
                     b2 ~ 1,
                     nl = T)

  nlprior <- c(prior(normal(100, 20), nlpar = "b0"),
...
Gradient evaluation took 0.000562 seconds
1000 transitions using 10 leapfrog steps per transition would take 5.62 seconds.
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 77.5605 seconds (Warm-up)
               76.8888 seconds (Sampling)
               154.449 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 86.2631 seconds (Warm-up)
               100.025 seconds (Sampling)
               186.289 seconds (Total)
...
b0_Intercept   122.53      3.39   116.92   130.34        492 1.00
b1_Intercept     0.02      0.00     0.01     0.03        538 1.00
b2_Intercept     1.00      0.05     0.91     1.09        481 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.07      0.37     4.44     5.85        840 1.00
...
#+begin_src R
          form <- bf(DBH ~ (b0/100) * (1 - exp(-b1 * AGE ^ b2)),
                     b0 ~ 1,
                     b1 ~ 1,
                     b2 ~ 1,
                     nl = T)
  ...
  model_fram_ftcollins_homo <- brm(form, chains = 4, cores = 2, data = fram_ftcollins, prior = nlprior,  control = list(adapt_delta = 0.95))
#+end_src
...
Exception: normal_lpdf: Location parameter[31] is inf, but must be finite!  (in 'model4f6553254765_file4f655dea9236' at line 44)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 6.30614 seconds (Warm-up)
               2.33982 seconds (Sampling)
               8.64596 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 6.35439 seconds (Warm-up)
               4.17114 seconds (Sampling)
               10.5255 seconds (Total)

Warning messages:
1: There were 1463 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help. See
http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
2: Examine the pairs() plot to diagnose sampling problems
#+end_example
...
#+begin_example
 Family: gaussian
  Links: mu = identity; sigma = identity
Formula: DBH ~ (b0/100) * (1 - exp(-b1 * AGE^b2))
         b0 ~ 1
         b1 ~ 1
         b2 ~ 1
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     0.51      1.11    -1.03     2.80          3 1.18
b1_Intercept    -0.03      0.50    -0.73     0.97          3 1.23
b2_Intercept     0.93      0.66     0.07     2.56         92 1.02

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma    50.37      5.83    38.77    62.00          5 1.09
...
2: There were 1463 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help.
