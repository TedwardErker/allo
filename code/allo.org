...
#+begin_src R
    ...
    nlprior <- c(prior(gamma(1, 2), nlpar = "b0"),
                 prior(gamma(1, 2), nlpar = "b1"),
                 prior(gamma(1, 2), nlpar = "b2"))

    model_fram_ftcollins_homo <- brm(form, chains = 2, cores = 2, data = fram_ftcollins,
                                     init_r = 1,
...
Exception: normal_lpdf: Location parameter[31] is inf, but must be finite!  (in 'model54b459fdb165_file54b45479179e' at line 44)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 12.1754 seconds (Warm-up)
               11.9724 seconds (Sampling)
               24.1478 seconds (Total)

Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 11.4406 seconds (Warm-up)
               15.4176 seconds (Sampling)
               26.8582 seconds (Total)
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.41      0.49     0.88     2.76        323 1.01
b1_Intercept     0.85      0.21     0.46     1.28        738 1.00
b2_Intercept     1.14      0.14     0.92     1.45        458 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.63      0.79     4.39     7.40        935 1.00
