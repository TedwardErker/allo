...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 20.1102 seconds (Warm-up)
               16.1524 seconds (Sampling)
               36.2626 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 20.4824 seconds (Warm-up)
               19.7054 seconds (Sampling)
               40.1878 seconds (Total)
#+end_example
...
b0_Intercept     1.21      0.04     1.15     1.30        529 1.01
b1_Intercept     2.68      0.35     2.05     3.39        565 1.01
b2_Intercept     0.92      0.04     0.83     1.01        519 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.06      0.37     4.42     5.86        681 1.00
...
#+begin_src R
  ...
  nlprior <- c(prior(normal(1, .3), nlpar = "b0"),
               prior(normal(1, .3), nlpar = "b1"),
               prior(normal(1, .1), nlpar = "b2"))

  model_fram_ftcollins_homo <- brm(form, chains = 2, cores = 2, data = fram_ftcollins, prior = nlprior,  control = list(adapt_delta = 0.8))
#+end_src
...
Exception: normal_lpdf: Location parameter[31] is -inf, but must be finite!  (in 'model54b41ccb5d2a_file54b46a74d6f0' at line 44)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 9.54789 seconds (Warm-up)
               12.2278 seconds (Sampling)
               21.7757 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 12.9477 seconds (Warm-up)
               13.1581 seconds (Sampling)
               26.1058 seconds (Total)
#+end_example
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     0.07      1.51    -2.21     2.46          1 3.86
b1_Intercept    -0.73      1.75    -3.96     1.26          1 3.21
b2_Intercept     0.91      0.20     0.67     1.30          1 2.47

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     5.86      0.83     4.56     7.78         24 1.03
