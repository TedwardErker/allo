...
: age_dbh_testing.rds
:
: sent 132 bytes  received 366 bytes  142.29 bytes/sec
...
: receiving file list ... done
:
: sent 16 bytes  received 143 bytes  45.43 bytes/sec
: total size is 58966646  speedup is 370859.41
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipHDD_1)     0.57      0.26     0.05     0.80          3 1.86
sds(b0_t2PrecipHDD_2)     0.58      0.26     0.05     0.81          3 1.82
sds(b0_t2PrecipHDD_3)     0.69      0.37     0.05     1.12          2 2.66
sds(sigma_sAGE_1)         1.11      0.27     0.78     1.68          3 1.88

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     1.07      0.25     0.53     1.60         10  1.10
sd(b1_Intercept)     0.63      0.32     0.21     0.96          2  5.96
sd(b2_Intercept)     0.65      0.51     0.09     1.22          2 23.28

~Genus (Number of levels: 8)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.56      0.47     0.01     1.16          2  6.21
sd(b1_Intercept)     0.57      0.49     0.01     1.13          2 11.03
sd(b2_Intercept)     0.64      0.61     0.00     1.31          2 38.32

~Genus:Species (Number of levels: 16)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
sd(b0_Intercept)     0.68      0.32     0.23     1.04          2  4.64
sd(b1_Intercept)     0.67      0.49     0.10     1.17          2 13.25
sd(b2_Intercept)     0.46      0.42     0.03     0.99          2 37.62

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample   Rhat
sigma_Intercept      1.09      1.02     0.04     2.14          2 125.32
b0_Intercept         1.37      0.56     0.77     2.43          2   2.53
b0_t2PrecipHDD_1     0.70      0.34     0.15     1.10          2   2.62
b0_t2PrecipHDD_2     0.60      0.23     0.16     0.86          3   1.83
b0_t2PrecipHDD_3     0.74      0.42     0.12     1.22          2   3.87
b1_Intercept         1.03      0.21     0.77     1.29          2   2.43
b2_Intercept         0.93      0.06     0.87     1.06          3   2.01
sigma_sAGE_1         0.64      0.49     0.14     1.40          2   4.26
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 10391 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
