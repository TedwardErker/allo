...
: In gzfile(file, "rb") :
:   cannot open compressed file '../models/genus_no_species_no_cities_many_climate_no_hetero_no_family_Gamma.rds', probable reason 'No such file or directory'
: Error: object 'mod_genus_no_species_no_cities_many_climate_no_hetero_no_family_Gamma' not found
