...
| Genus | species | cities | climate predictors | heteroskedasticity | b0                    | data                                       | b1           | b2           | sigma          | formula                                                                                            |
|-------+---------+--------+--------------------+--------------------+-----------------------+--------------------------------------------+--------------+--------------+----------------+----------------------------------------------------------------------------------------------------|
| none  | single  | single | none               | no                 | b0 ~ 1                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b1 ~ 1       | b2 ~ 1       |                | bf(y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)),  b0 ~ 1,  b1 ~ 1,  b2 ~ 1, nl = T)                  |
| none  | single  | single | none               | yes                | b0 ~ 1                | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              | sigma ~ AGE -1 | bf(y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)),  sigma ~ AGE - 1, b0 ~ 1,  b1 ~ 1,  b2 ~ 1, nl = T) |
| none  | many    | single | none               | no                 | b0 ~ (1 \vert Species) | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) | b1 ~ Species | b2 ~ Species |                |                                                                                                    |
| many  | many    | single | none               | no                 | b0 ~                  | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| many  | many    | single | none               | yes                |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| none  | single  | many   | none               | no                 |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| none  | single  | many   | on \beta_0         | no                 |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| none  | single  | many   | none               | yes                |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| none  | single  | many   | on \beta_0         | yes                |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| many  | many    | many   | on \beta_0         | no                 |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
| many  | many    | many   | on \beta_0         | yes                |                       | y ~ 100*b0 * (1 - exp(-(b1/100) * x ^ b2)) |              |              |                |                                                                                                    |
|       |         |        |                    |                    |                       |                                            |              |              |                |                                                                                                    |
|       |         |        |                    |                    |                       |                                            |              |              |                |                                                                                                    |
