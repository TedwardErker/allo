...
#+begin_src R
  ...
  model_fram_homo <- update(m_generated_singleSpecies_multipleLocations_homo, newdata = fram, cores = 2)
...
~City (Number of levels: 4)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     1.33      1.63     0.02     4.04          2 3.97
sd(b1_Intercept)     1.69      2.12     0.03     5.31          2 7.00
sd(b2_Intercept)     0.74      0.76     0.01     1.98          2 8.91

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample  Rhat
b0_Intercept     2.29      0.93     0.93     3.63          2  2.32
b1_Intercept     0.69      0.49     0.18     1.66          2  2.37
b2_Intercept     2.47      1.83     0.88     5.51          2 24.01

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     4.75      1.71     2.83     7.13          2 6.25
...
2: There were 38 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
