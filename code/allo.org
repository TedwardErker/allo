...
: genus_none_species_single_cities_single_climate_none_hetero_linear.R
:
: sent 710 bytes  received 42 bytes  300.80 bytes/sec
: total size is 1351  speedup is 1.80
