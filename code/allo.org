...
: allo_functions.R
:
: sent 1110 bytes  received 60 bytes  30.39 bytes/sec
: total size is 5024  speedup is 4.29
: You have new mail in /var/mail/erker
...
#+begin_src R
  ...
  mod <- brm(form, chains = 2, cores = 2, data = d, init_r = .3, prior = nlprior, iter = 500, family = family)
...
sigma_Intercept     2.68      0.01     2.66     2.70        438 1.00
b0_Intercept        1.43      0.10     1.26     1.63        146 1.00
b1_Intercept        1.40      0.06     1.29     1.51        254 1.00
b2_Intercept        0.97      0.03     0.92     1.02        140 1.00
