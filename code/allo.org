...
: 
: sent 625 bytes  received 54 bytes  271.60 bytes/sec
: total size is 1274  speedup is 1.88
: You have new mail in /var/mail/erker
...
#+begin_src R
me_species <-readRDS("~/git/allo/models/genus_many_species_many_cities_notB1_many_climate_b3linint_hetero_no_family_Gamma_FullData_marginaleffects_Species.rds")
#+end_src

#+RESULTS:

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_notB1_climate_b3linint_hetero_no_family_Gamma_FullData_full_singlepane_GenusEffects_points.png :width 1000 :height 800 :res 170 :bg transparent
...
Warning message:
package ‘htmlwidgets’ was built under R version 3.4.4
#+end_example
