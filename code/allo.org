...
tree.  Pragmatically, it models/causes the slowing of the diameter growth of a tree
as it ages.
...
another, especially \beta_1 and \beta_3.  Without very old trees that are close
...
for beta_3
\[
\beta_{3sc[i]} = \beta_3 + \tau_1 * Precip_i + \tau_2 * GDD_i + \tau_3 *
(Precip_i * GDD_i) + \gamma_{3s[i]}+\delta_{3c[i]}
\]
...
Species effect:
\[
\gamma_{js[i]} \sim N(\gamma_{jg[i]}, \sigma_{j s[i]})
\]

Genus effect:
\[
\gamma_{jg[i]} \sim N(0, \sigma_{j g[i]})
\]
...
\[
\delta_{jc} \sim N(0, \sigma_{j c[i]})
\]
...
| \beta_3  intercept (climate,genus,species) |   .3 | .15 |               4. |       13.333333 |
...
species is half of genus

\[
\sigma_{0_c[i]} \sim \text{Normal}(0, .5)
\]

\[
\sigma_{0_g[i]} \sim \text{Normal}(0, .5)
\]

\[
\sigma_{0_s[i]} \sim \text{Normal}(0, .25)
\]
...
because there is also species variation, which I'll set to .2 since I
...
for beta_1
\[
\sigma_{1_g[i]} \sim half-Normal(0, .13)
\]

\[
\sigma_{1_s[i]} \sim half-Normal(0, .06)
\]

\[
\sigma_{1_c[i]} \sim half-Normal(0, .06)
\]
...
\[
\sigma_{2_g[i]} \sim half-Normal(0, .06)
\]

\[
\sigma_{2_s[i]} \sim half-Normal(0, .03)
\]

\[
\sigma_{2_c[i]} \sim half-Normal(0, .03)
\]

\[
\sigma_{3_g[i]} \sim half-Normal(0, .06)
\]

\[
\sigma_{3_s[i]} \sim half-Normal(0, .03)
\]

\[
\sigma_{3_c[i]} \sim half-Normal(0, .03)
\]
...
positive.  I expect the increase in asympote across this range to be
...
gdd
\[
\tau_2 \sim Normal(.03, .01)
\]

gdd:preci
\[
\tau_3 \sim Normal(.025, .01)
\]
...
Gradient evaluation took 0.021605 seconds
1000 transitions using 10 leapfrog steps per transition would take 216.05 seconds.
Adjust your expectations accordingly!
...
Gradient evaluation took 0.021764 seconds
1000 transitions using 10 leapfrog steps per transition would take 217.64 seconds.
Adjust your expectations accordingly!
...
Iteration: 500 / 500 [100%]  (Sampling)
 ...
 Elapsed Time: 45.8612 seconds (Warm-up)
               31.7002 seconds (Sampling)
               77.5614 seconds (Total)

Iteration: 500 / 500 [100%]  (Sampling)

 Elapsed Time: 48.4155 seconds (Warm-up)
               33.85 seconds (Sampling)
               82.2656 seconds (Total)
#+end_example
...
*** many cities
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes
:END:
**** model R code
...
:
: sent 878 bytes  received 66 bytes  377.60 bytes/sec
: total size is 2710  speedup is 2.87
: You have new mail in /var/mail/erker
...
:
: sent 25982 bytes  received 17844101 bytes  3971129.56 bytes/sec
: total size is 18021864  speedup is 1.01
: You have new mail in /var/mail/erker
...
Samples: 6 chains, each with iter = 500; warmup = 250; thin = 1;
         total post-warmup samples = 1500

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.76      0.10     0.58     0.97        697 1.01
sd(b2_Intercept)     0.30      0.04     0.23     0.40        658 1.01
sd(b3_Intercept)     0.10      0.02     0.07     0.14          5 1.60

~Genus (Number of levels: 17)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.28      0.11     0.05     0.48         11 1.16
sd(b1_Intercept)     0.34      0.09     0.18     0.50          5 1.54
sd(b2_Intercept)     0.17      0.03     0.12     0.22        629 1.02
sd(b3_Intercept)     0.09      0.02     0.04     0.13        270 1.03

~Genus:Species (Number of levels: 24)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.05      0.04     0.00     0.15        657 1.00
sd(b1_Intercept)     0.04      0.03     0.00     0.12        392 1.01
sd(b2_Intercept)     0.05      0.02     0.01     0.09         10 1.20
sd(b3_Intercept)     0.05      0.01     0.03     0.08        144 1.03

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     2.52      0.31     1.93     3.09          6 1.38
b1_Intercept     1.49      0.18     1.17     1.83          4 1.77
b2_Intercept     0.99      0.08     0.84     1.15        336 1.02
b3_Intercept     1.10      0.05     1.01     1.20          7 1.31

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.32      0.32    13.69    14.95       1500 1.11
...
:
: sent 38 bytes  received 12044590 bytes  2676584.00 bytes/sec
: total size is 12136389  speedup is 1.01
: You have new mail in /var/mail/erker
...
Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      2.77      0.08     2.62     2.93       2104 1.00
b1_Intercept      1.07      0.07     0.96     1.21       1197 1.01
b1_gdd            0.00      0.00     0.00     0.01       1676 1.00
b1_precip         0.07      0.01     0.05     0.10       1559 1.00
b1_gdd:precip     0.01      0.00     0.00     0.01       1577 1.00
b2_Intercept      0.92      0.04     0.83     0.99       1586 1.00
b3_Intercept      1.08      0.02     1.05     1.11       1501 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     8.41      0.16     8.11     8.73       2646 1.00
...
:
: sent 38 bytes  received 12038846 bytes  2675307.56 bytes/sec
: total size is 12131606  speedup is 1.01
...
*** compare climate beta 1 to climate beta 3
#+begin_src R
...
*** genus: many;  species: many; cities: many; climate: b3linint; hetero: no; family: Gamma
**** model R code
#+begin_src R :tangle genus_species_cities_b3climate_loose.R
  library(dplyr)
  library(brms)
...
: erker@krusty's password:
: building file list ... done
: genus_species_cities_b3climate_loose.R
:
: sent 926 bytes  received 42 bytes  276.57 bytes/sec
: total size is 2824  speedup is 2.92
...
:
: sent 45930 bytes  received 102707768 bytes  4779241.77 bytes/sec
: total size is 102849233  speedup is 1.00
: You have new mail in /var/mail/erker
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.48      0.05     0.38     0.59      24000 1.00
sd(b1_Intercept)     0.43      0.14     0.25     0.80         11 1.51
sd(b2_Intercept)     0.16      0.02     0.13     0.19      24000 1.00
sd(b3_Intercept)     0.10      0.01     0.07     0.13      24000 1.04

~Genus (Number of levels: 17)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.35      0.09     0.19     0.54       2318 1.01
sd(b1_Intercept)     0.60      0.16     0.26     0.91         13 1.33
sd(b2_Intercept)     0.13      0.03     0.08     0.19         90 1.03
sd(b3_Intercept)     0.10      0.03     0.02     0.15         15 1.29

~Genus:Species (Number of levels: 24)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.05      0.03     0.00     0.13      17941 1.00
sd(b1_Intercept)     0.11      0.07     0.01     0.26         17 1.24
sd(b2_Intercept)     0.06      0.02     0.02     0.10         40 1.08
sd(b3_Intercept)     0.05      0.01     0.03     0.08        682 1.01

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      2.51      0.17     2.17     2.85      16277 1.00
b1_Intercept      1.67      0.17     1.34     2.02      13060 1.00
b2_Intercept      0.86      0.06     0.75     0.98        475 1.01
b3_Intercept      0.97      0.06     0.85     1.08         75 1.04
b3_precip         0.01      0.01     0.00     0.03      24000 1.01
b3_gdd            0.01      0.01     0.00     0.02      24000 1.02
b3_precip:gdd     0.00      0.00     0.00     0.01         27 1.13

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.91      0.29    14.34    15.48      24000 1.00
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.48      0.05     0.38     0.59         84 1.03
sd(b1_Intercept)     0.19      0.03     0.14     0.25        193 1.03
sd(b2_Intercept)     0.17      0.02     0.13     0.20         52 1.06
sd(b3_Intercept)     0.08      0.01     0.06     0.11        100 1.03

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.35      0.09     0.18     0.55       2404 1.00
sd(b1_Intercept)     0.39      0.07     0.23     0.52         18 1.33
sd(b2_Intercept)     0.18      0.03     0.12     0.24        234 1.03
sd(b3_Intercept)     0.19      0.02     0.15     0.24       4488 1.01

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.05      0.04     0.00     0.13       5272 1.00
sd(b1_Intercept)     0.07      0.04     0.01     0.15         56 1.10
sd(b2_Intercept)     0.06      0.02     0.01     0.09         92 1.06
sd(b3_Intercept)     0.05      0.01     0.02     0.08        233 1.03

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      2.64      0.20     2.27     3.07         21 1.14
b1_Intercept      1.39      0.15     1.09     1.66         16 1.32
b2_Intercept      0.96      0.06     0.84     1.09        614 1.01
b3_Intercept      1.02      0.07     0.88     1.15         44 1.07
b3_precip         0.01      0.01     0.00     0.03       8000 1.00
b3_gdd            0.01      0.01     0.00     0.02       8000 1.00
b3_precip:gdd     0.00      0.00     0.00     0.01          8 1.77

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.67      0.31    14.05    15.28         25 1.12
...
Looking at this plot, it seems like many of the parameters end up
converging eventually.  For the sd priors, I wonder if using a prior
that has less mass around zero would be helpful?
...
#+begin_src R :exports results :results graphics :file ../figs/predictions_dbh_bySpeciesFull_wData.png :height 1200 :width 1200
  ...
  ggplot() +
      geom_point(data = d, aes( x = AGE, y = DBH, color = Region), alpha = .7, size = .5) +
      facet_wrap(~Species, scales = "free") +
      theme_minimal() +
      theme(text = element_text(size = 20),
            legend.position = "none") +
      geom_line(data = predictions_apprange, aes(x = AGE, y = predicted_dbh, group = Region), size = 1.5)
...
#+begin_src R :exports results :results graphics :file ../figs/genus_species_cities_climateb3_predictions.png :width 1000 :height 1000
#    pred <- predict(mod, newdata = d)
 # pred.df <- cbind(d, pred)

      ggplot(pred.df, aes(x = AGE, y = DBH)) +
          geom_point() +
          facet_grid(Genus~City) +
        geom_line(data = pred.df, aes(x = AGE, y = Estimate), inherit.aes = F, color = "blue")
 #       geom_ribbon(data = pred.df, aes(x = AGE, ymin = Q2.5, ymax = Q97.5), inherit.aes = F, fill = "blue", alpha = .2)
#+end_src

#+RESULTS:
[[file:../figs/genus_species_cities_climateb3_predictions.png]]
