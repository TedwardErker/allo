...
make_stancode(form, dt, prior = nlprior)
#+end_src

#+RESULTS:

Fix the stan code
#+BEGIN_SRC stan :tangle singleSpeciesLocation_hetero.stan
// generated with brms 2.3.1
functions {
}
data {
...
#+begin_src R
m_fixed <- stan("singleSpeciesLocation_hetero.stan", data = make_standata(form, dt, prior = nlprior))
m_fixed
#+end_src
