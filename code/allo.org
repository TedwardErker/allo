...
Therefore, the sd for \delta, \sigma_

standard deviation for cities might be around
There's a 90% chance the sd for \beta_0 is less than 3 *
\[
\sigma_{0_c[i]} \sim \text{Normal}(0, 1)
\]
