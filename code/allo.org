...
species were measured in multiple cities, but not most.  The number of
trees of each city - species combination sampled ranged from 1
(both Liquidambar styraciflu and Prunus serrulata in Queens, NY) to 79
(Quercus laurifolia in Charleston, SC)
...
