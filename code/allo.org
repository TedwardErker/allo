...
#+begin_src R :tangle allo_functions.R
  ...
  generate_prior <- function (gen, sp, cit, clim, fam) {
      if(fam == "gaussian") {
          nlprior <- c(prior(gamma(7, 7), nlpar = "b1",lb = 0),       #mean = 4/3 = 1.3; variance = 4/9 = .4
      ...
      if(fam == "Gamma") {
          nlprior <- c(prior(gamma(1, .2), nlpar = "b1",lb = 0),
                       prior(gamma(1, .2), nlpar = "b2", lb = 0),
                       prior(gamma(1, .2), nlpar = "b3",lb = 0))
...
#+begin_src R
  ...
  nlprior <- generate_prior(genus, species, cities, climate, family)
          ...
          nlprior <- c(prior(gamma(7, 7), nlpar = "b1",lb = 0),
...
Formula: DBH ~ b1 * (1 - exp(-(b2) * AGE^b3))
         b1 ~ 1
         b2 ~ 1
         b3 ~ 1
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b1_Intercept     4.96      0.06     4.84     5.08        786 1.00
b2_Intercept     0.29      0.00     0.28     0.29        802 1.00
b3_Intercept     0.48      0.01     0.46     0.50        735 1.00
...
~Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.45      0.08     0.32     0.64       1309 1.00
sd(b2_Intercept)     0.06      0.02     0.04     0.10        834 1.01
sd(b3_Intercept)     0.07      0.02     0.04     0.12        917 1.01

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b1_Intercept     4.70      0.10     4.50     4.92       1000 1.00
b2_Intercept     0.29      0.01     0.26     0.32        617 1.02
b3_Intercept     0.54      0.02     0.50     0.57       1486 1.00
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.57      0.22     0.29     1.12          5 1.56
sd(b2_Intercept)     0.05      0.01     0.03     0.08         36 1.04
sd(b3_Intercept)     0.07      0.02     0.04     0.12          8 1.24

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.48      0.38     0.01     1.24          9 1.22
sd(b2_Intercept)     0.05      0.02     0.01     0.11         26 1.06
sd(b3_Intercept)     0.08      0.03     0.01     0.14         20 1.08

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.43      0.21     0.15     0.93         80 1.05
sd(b2_Intercept)     0.02      0.01     0.00     0.05         10 1.18
sd(b3_Intercept)     0.03      0.02     0.00     0.09         13 1.12

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b1_Intercept     5.15      0.32     4.61     5.91          8 1.24
b2_Intercept     0.27      0.02     0.23     0.32         87 1.03
b3_Intercept     0.49      0.04     0.41     0.56          9 1.20
...
*** TODO genus: many;  species: many; cities: many; climate: b1linint; hetero: no; family: gaussian
:PROPERTIES:
...
*** TODO genus: many;  species: many; cities: many; climate: b1linint; hetero: no; family: Gamma NO CONVERGE; DO MATH, FIND BETTER PRIORS
:PROPERTIES:
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.50      0.14     0.28     0.85      13468 1.00
sd(b2_Intercept)     0.05      0.01     0.03     0.07         25 1.06
sd(b3_Intercept)     0.08      0.02     0.04     0.13         14 1.12

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.53      0.39     0.01     1.26       1526 1.01
sd(b2_Intercept)     0.04      0.02     0.01     0.08         13 1.13
sd(b3_Intercept)     0.06      0.03     0.00     0.12         27 1.06

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b1_Intercept)     0.53      0.25     0.18     1.02        167 1.02
sd(b2_Intercept)     0.02      0.01     0.00     0.04         13 1.13
sd(b3_Intercept)     0.05      0.02     0.01     0.09        120 1.02

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b1_Intercept      5.56      0.37     4.77     6.25          7 1.29
b1_Precip         0.57      0.37     0.02     1.37         10 1.17
b1_GDD            0.30      0.16     0.00     0.60          5 1.50
b1_Precip:GDD     0.31      0.21     0.02     0.78         29 1.05
b2_Intercept      0.27      0.02     0.23     0.31         60 1.03
b3_Intercept      0.46      0.04     0.39     0.54         10 1.18
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b1linint_hetero_no_family_Gamma.png
  plot(mod, ask = F)
#+end_src
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b1linint_hetero_no_family_Gamma.png
  marginal_effects(mod, effects = "AGE:GDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b1linint_hetero_no_family_Gamma.png]]
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b1linint_hetero_no_family_Gamma.png
precip.gdd <-   marginal_effects(mod, effects = "Precip:GDD", surface = T)
precip.gdd
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b1linint_hetero_no_family_Gamma.png]]
