...
:
: sent 148 bytes  received 20 bytes  48.00 bytes/sec
: total size is 1490  speedup is 8.87
...
: many_cities.R
:
: sent 126 bytes  received 60 bytes  53.14 bytes/sec
: total size is 1826  speedup is 9.82
...
: genus_species.R
:
: sent 128 bytes  received 66 bytes  77.60 bytes/sec
: total size is 2226  speedup is 11.47
...
*** genus: many;  species: many; cities: many (not \beta_1); climate: b3linint; hetero: no; family: Gamma
**** model R code
...
:
: sent 877 bytes  received 42 bytes  262.57 bytes/sec
: total size is 2450  speedup is 2.67
: You have new mail in /var/mail/erker
