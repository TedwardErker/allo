...
: allo_functions.R
:
: sent 239 bytes  received 96 bytes  134.00 bytes/sec
: total size is 6266  speedup is 18.70
...
:
: sent 55723 bytes  received 22989318 bytes  4190007.45 bytes/sec
: total size is 23108206  speedup is 1.00
: You have new mail in /var/mail/erker
