...
: allo_functions.R
:
: sent 335 bytes  received 96 bytes  172.40 bytes/sec
: total size is 6258  speedup is 14.52
...
:
: sent 28928 bytes  received 18695712 bytes  4161031.11 bytes/sec
: total size is 18809670  speedup is 1.00
: You have new mail in /var/mail/erker
...
Formula: DBH ~ b0 + 100 * b1 * (1 - exp(-(b2/100) * AGE^(b3)))
         ...
         b3 ~ (1 | ID | Species)
   Data: d (Number of observations: 5548)
Samples: 7 chains, each with iter = 1000; warmup = 500; thin = 1;
         total post-warmup samples = 3500

Group-Level Effects:
~Species (Number of levels: 25)
                               Estimate Est.Error l-95% CI u-95% CI Eff.Sample
sd(b0_Intercept)                   0.17      0.10     0.01     0.40       1074
sd(b1_Intercept)                   0.73      0.26     0.22     1.23          7
sd(b3_Intercept)                   0.23      0.04     0.17     0.31        970
sd(b2_Intercept)                   0.42      0.10     0.27     0.66       1180
cor(b1_Intercept,b3_Intercept)    -0.90      0.08    -0.98    -0.70         11
                               Rhat
sd(b0_Intercept)               1.01
sd(b1_Intercept)               1.43
sd(b3_Intercept)               1.01
sd(b2_Intercept)               1.00
cor(b1_Intercept,b3_Intercept) 1.19

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     2.81      0.09     2.65     2.99       3500 1.01
b1_Intercept     1.27      0.19     0.96     1.65         12 1.18
b2_Intercept     0.99      0.10     0.80     1.20        516 1.02
b3_Intercept     1.16      0.05     1.06     1.26         22 1.09

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape     9.84      0.19     9.46    10.21       3500 1.00
...
2: There were 14 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
...
#+RESULTS:
[[file:../figs/plot_genus_none_species_many_cities_single_climate_none_hetero_no_family_Gamma_1.png]]
...
:
: sent 443 bytes  received 54 bytes  58.47 bytes/sec
: total size is 1214  speedup is 2.44
...
:
: sent 190 bytes  received 54 bytes  32.53 bytes/sec
: total size is 1214  speedup is 4.98
...
: total size is 123529082  speedup is 709937.25
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     1.69      0.43     1.03     2.47          9 1.22
sd(b1_Intercept)     0.48      0.40     0.16     1.64         23 1.12
sd(b2_Intercept)     0.33      0.07     0.21     0.50        192 1.03
sd(b3_Intercept)     0.17      0.04     0.12     0.25         22 1.10

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     2.07      1.97     0.12     5.95         19 1.37
sd(b1_Intercept)     0.89      0.69     0.01     2.13         17 1.37
sd(b2_Intercept)     0.08      0.08     0.00     0.28         13 1.41
sd(b3_Intercept)     0.05      0.05     0.00     0.17         11 1.21

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.23      0.16     0.02     0.63         39 1.04
sd(b1_Intercept)     0.33      0.14     0.15     0.57         12 1.16
sd(b2_Intercept)     0.12      0.04     0.04     0.20         12 1.16
sd(b3_Intercept)     0.09      0.03     0.04     0.17         23 1.27

Population-Level Effects:
              Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept      2.29      0.52     1.30     3.53        414 1.02
b1_Intercept      0.48      0.18     0.19     0.92         61 1.06
b1_Precip         0.51      0.18     0.22     0.96        422 1.01
b1_GDD            0.18      0.06     0.08     0.30         34 1.10
b1_Precip:GDD     0.18      0.06     0.09     0.34         15 1.13
b2_Intercept      0.81      0.09     0.62     1.00        187 1.03
b3_Intercept      1.05      0.05     0.95     1.16         21 1.10

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    15.03      0.27    14.49    15.55        130 1.04
...
1: The model has not converged (some Rhats are > 1.1). Do not analyse the results!
We recommend running more iterations and/or setting stronger priors.
2: There were 9754 divergent transitions after warmup. Increasing adapt_delta above 0.8 may help.
See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#+end_example
