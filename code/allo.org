...
#+RESULTS:
: erker@krusty's password:
: building file list ... rsync: link_stat "/Users/erker/git/allo/code/genus_species_cities.R" failed: No such file or directory (2)
: done
:
...
#+begin_src R
  ...
  mod <- brm(form,
             ...
             prior = nlprior,
             family = Gamma("identity"),
             chains = 1, cores = 1, init_r = .3, iter = 300)
