...
| many  | many    | many   | b0linint | smooth  | DBH ~ 100*b0 * (1 - exp(-(b1/100) * AGE ^ b2)) | b0 ~ Precip * HDD +  (1 \vert City) + (1 \vert Genus / Species)    | b1 ~ (1 \vert City) + (1 \vert Genus / Species) | b2 ~ (1 \vert City) + (1 \vert Genus / Species) | sigma ~ s(AGE)        |
...
| model_table.csv |           |       |          |         |                 |       |           |
|                 |           |       |          |         |                 |       |           |
| sent            | 220       | bytes | received | 72      | bytes           | 83.43 | bytes/sec |
| total           | size      | is    | 3220     | speedup | is              | 11.03 |           |
| You             | have      | new   | mail     | in      | /var/mail/erker |       |           |
