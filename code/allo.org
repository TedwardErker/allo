...
: allo_functions.R
:
: sent 299 bytes  received 60 bytes  143.60 bytes/sec
: total size is 1784  speedup is 4.97
...
#+RESULTS:
[[file:../figs/ttest.png]]
*** CHANGE THE FAMILY TO BE STRICTLY POSITIVVE , maybe GAmma.
...
:
: sent 483 bytes  received 66 bytes  64.59 bytes/sec
: total size is 2152  speedup is 3.92
...
sent 20876 bytes  received 11518907 bytes  923182.64 bytes/sec
total size is 11609727  speedup is 1.01
...
*** TODO genus: many;  species: many; cities: many; climate: none; hetero: smooth
:PROPERTIES:
...
*** TODO genus: many;  species: many; cities: many; climate: none; hetero: linear
:PROPERTIES:
...
*** TODO genus: many;  species: many; cities: many; climate: b0linint; hetero: smooth  NO CONVERGE
:PROPERTIES:
