...
:
: sent 558 bytes  received 66 bytes  113.45 bytes/sec
: total size is 2596  speedup is 4.16
...
:
: sent 923 bytes  received 60 bytes  280.86 bytes/sec
: total size is 2882  speedup is 2.93
: You have new mail in /var/mail/erker
