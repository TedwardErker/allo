...
#+begin_src R
  ...
  d2.noWARO <- filter(d2, Species != "WARO")

  saveRDS(d2.noWARO, "../data/age_dbh_full_noWARO.rds")
...
rsync -avz ../data/age_dbh_full_noWARO.rds erker@krusty:~/allo/data/
#+END_SRC
...
:
: sent 457 bytes  received 66 bytes  26.82 bytes/sec
: total size is 2627  speedup is 5.02
: You have new mail in /var/mail/erker
...
:
: sent 29660 bytes  received 18506620 bytes  4119173.33 bytes/sec
: total size is 18676129  speedup is 1.01
: You have new mail in /var/mail/erker
...
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.73      0.11     0.55     0.96         17 1.09
sd(b1_Intercept)     0.35      0.10     0.17     0.50          4 2.06
sd(b2_Intercept)     0.28      0.05     0.20     0.39         22 1.07
sd(b3_Intercept)     0.10      0.02     0.07     0.13         11 1.16

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.42      0.11     0.23     0.66         15 1.11
sd(b1_Intercept)     0.48      0.06     0.37     0.60       1500 1.00
sd(b2_Intercept)     0.19      0.05     0.11     0.29          4 1.72
sd(b3_Intercept)     0.12      0.02     0.07     0.17         11 1.16

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.04      0.04     0.00     0.13       1131 1.00
sd(b1_Intercept)     0.13      0.04     0.03     0.20          8 1.24
sd(b2_Intercept)     0.05      0.02     0.01     0.09         14 1.12
sd(b3_Intercept)     0.05      0.02     0.01     0.08        205 1.03

Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     2.48      0.23     2.01     2.93        140 1.03
b1_Intercept     1.68      0.16     1.38     1.99        308 1.04
b2_Intercept     1.03      0.08     0.88     1.20        737 1.01
b3_Intercept     1.06      0.04     0.98     1.14        176 1.04

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
shape    14.83      0.29    14.28    15.40       1500 1.00
...
: total size is 42337983  speedup is 243321.74
