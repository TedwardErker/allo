...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 5.14538 seconds (Warm-up)
               1.21728 seconds (Sampling)
               6.36267 seconds (Total)

Iteration: 1800 / 2000 [ 90%]  (Sampling)
Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 5.09669 seconds (Warm-up)
               1.19105 seconds (Sampling)
               6.28774 seconds (Total)
#+end_example
...
Population-Level Effects:
          Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
Intercept     0.19      0.49    -0.74     1.25        651 1.00
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.47304 seconds (Warm-up)
               1.17021 seconds (Sampling)
               2.64325 seconds (Total)


SAMPLING FOR MODEL 'simple' NOW (CHAIN 2).
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.0694882, but must be > 0!  (in 'model54b4740ffb71_simple' at line 29)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.4316 seconds (Warm-up)
               2.06907 seconds (Sampling)
               3.50067 seconds (Total)


SAMPLING FOR MODEL 'simple' NOW (CHAIN 3).
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.962771, but must be > 0!  (in 'model54b4740ffb71_simple' at line 29)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.50928 seconds (Warm-up)
               1.80202 seconds (Sampling)
               3.3113 seconds (Total)
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 1.39526 seconds (Warm-up)
               1.35719 seconds (Sampling)
               2.75245 seconds (Total)
#+end_example
...
Iteration: 2000 / 2000 [100%]  (Sampling)
 ...
 Elapsed Time: 11.6314 seconds (Warm-up)
               12.6795 seconds (Sampling)
               24.3109 seconds (Total)

Iteration: 2000 / 2000 [100%]  (Sampling)

 Elapsed Time: 14.4999 seconds (Warm-up)
               11.0714 seconds (Sampling)
               25.5713 seconds (Total)
#+end_example
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.40      0.33     1.00     2.28        338 1.00
b1_Intercept     0.95      0.12     0.72     1.19        643 1.00
b2_Intercept     0.97      0.06     0.86     1.09        456 1.00
sigma_AGE        0.02      0.00     0.01     0.02       1227 1.00
...
SAMPLING FOR MODEL 'singleSpeciesLocation_hetero_fixed' NOW (CHAIN 1).
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is 0, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Stan model 'singleSpeciesLocation_hetero_fixed' does not contain samples.
#+end_example
...
#+begin_src R
  ...
  initf1 <- function() list(sigma = 100)

  model_fram_ftcollins_hetero <- stan("singleSpeciesLocation_hetero_fixed.stan", data = make_standata(form, fram_ftcollins, prior = nlprior), init = initf1)
#  model_fram_ftcollins_hetero <- stan("singleSpeciesLocation_hetero_fixed.stan", data = make_standata(form, dt, prior = nlprior), init = initf1)
#+end_src
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[31] is 0, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -33.4667, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.32663, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -18.4091, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -54.6108, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.0667, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.601129, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -50.2865, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -2.55025, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.5548, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -3.59523, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -10.1586, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -35.4121, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -20.2728, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -31.3791, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -47.7728, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -24.7531, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.2596, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -18.5381, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -24.782, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -30.3844, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -55.3359, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.7854, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -52.0443, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.69394, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -11.1269, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -35.801, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.81806, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -19.719, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -23.8603, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -0.649481, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -55.0662, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -52.7088, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -47.0225, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -9.84232, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -30.374, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -12.1169, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -33.4545, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -32.0488, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -5.64414, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -39.1402, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -8.95718, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -54.2693, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -3.60448, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -22.1129, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -1.04548, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -16.0619, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -40.4507, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -21.955, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)

Rejecting initial value:
  Error evaluating the log probability at the initial value.
Exception: normal_lpdf: Scale parameter[1] is -34.0463, but must be > 0!  (in 'model54b4304d7f68_singleSpeciesLocation_hetero_fixed' at line 49)
...
m_generated_singleSpecies_multipleLocations_homo <- m
#+end_src
...
Population-Level Effects:
             Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept     1.25      0.08     1.09     1.39        761 1.01
b0_Cityb         0.03      0.02     0.00     0.07       2000 1.00
b0_Cityc         0.20      0.08     0.06     0.36        768 1.01
b0_Cityd         0.14      0.07     0.02     0.29       1491 1.00
b1_Intercept     1.60      0.22     1.19     2.05       1209 1.00
b1_Cityb         0.04      0.03     0.00     0.12       2000 1.00
b1_Cityc         0.57      0.33     0.08     1.30       1318 1.00
b1_Cityd         0.44      0.21     0.09     0.88       1320 1.00
b2_Intercept     0.88      0.05     0.80     0.97        870 1.00
b2_Cityb         0.01      0.00     0.00     0.02       2000 1.00
b2_Cityc         0.32      0.06     0.21     0.42        999 1.00
b2_Cityd         0.06      0.03     0.01     0.12       1565 1.00

Family Specific Parameters:
      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sigma     4.83      0.38     4.15     5.64       2000 1.00
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_pts.png
fe <- fixef(m)[c(1,5,9),1]
b0 <- fe[1]
b1 <- fe[2]
b2 <- fe[3]

predicted <- w(b0,b1,b2, AGE)
plot(AGE, predicted)
#  me <-   marginal_effects(m_generated_singleSpecies_multipleLocations_homo, effects = "AGE")
...
*** single species, multiple locations, climate predictors for locations, homoskedasticyt..sysgnsy
*** explaining priors
can't be negative...
