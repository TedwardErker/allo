...
:
: sent 401 bytes  received 54 bytes  53.53 bytes/sec
...
:END:
#+begin_src R
mod <- readRDS("~/git/allo/models/genus_none_species_many_cities_single_climate_none_hetero_no_family_gaussian.rds")
#+end_src
...
#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_none_species_many_cities_single_climate_none_hetero_no_family_gaussian.png :width 800
...
*** genus: many;  species: many; cities: many; climate: b0linint; hetero: no; family: Gamma
:PROPERTIES:
:header-args:R: :cache no :results output :exports both :comments link :session *R:allo3* :eval yes :tangle genus_many_species_many_cities_many_climate_b0_hetero_no.R
:END:
**** libraries and functions
#+begin_src R
  library(dplyr)
...
#+BEGIN_SRC sh :session a :results verbatim
  ...
  rsync -avz genus_many_species_many_cities_many_climate_b0_hetero_no.R erker@krusty:~/allo/code/
...
: erker@krusty's password:
: building file list ... done
: genus_many_species_many_cities_many_climate_b0_hetero_no.R
:
: sent 365 bytes  received 54 bytes  167.60 bytes/sec
: total size is 1135  speedup is 2.71
...
#+BEGIN_SRC sh :session b :results raw
  ssh krusty
  cd allo/code
  nohup R CMD BATCH genus_many_species_many_cities_many_climate_b0_hetero_no.R &
  exit
#+END_SRC
...
#+BEGIN_SRC sh :session a :results verbatim
rsync -avz erker@krusty:~/allo/models/genus_many_species_many_cities_many_climate_b0_hetero_no.rds ~/git/allo/models/
#+END_SRC

#+RESULTS:
: erker@krusty's password:
: receiving file list ... done
: genus_many_species_many_cities_many_climate_b0_hetero_no.rds
:
: sent 55366 bytes  received 30871852 bytes  2290905.04 bytes/sec
: total size is 31017908  speedup is 1.00
...
:END:
#+begin_src R
mod <- readRDS("~/git/allo/models/genus_many_species_many_cities_many_climate_b0_hetero_no.rds")
#+end_src

#+RESULTS:


#+begin_src R :exports results :results graphics :file ../figs/pairs_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  pairs(mod)
#+end_src

#+RESULTS:
[[file:../figs/pairs_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]
...
#+begin_example
 Family: gaussian
  Links: mu = identity; sigma = identity
Formula: DBH ~ 100 * b0 * (1 - exp(-(b1/100) * AGE^b2))
         b0 ~ t2(Precip, CDD) + (1 | City) + (1 | Genus/Species)
         b1 ~ (1 | City) + (1 | Genus/Species)
         b2 ~ (1 | City) + (1 | Genus/Species)
   Data: d (Number of observations: 5548)
Samples: 6 chains, each with iter = 2000; warmup = 1000; thin = 1;
...
Smooth Terms:
                      Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sds(b0_t2PrecipCDD_1)     0.48      0.40     0.01     1.08          4 2.50
sds(b0_t2PrecipCDD_2)     0.47      0.39     0.00     1.04          4 2.10
sds(b0_t2PrecipCDD_3)     0.58      0.52     0.01     1.30          3 3.24

Group-Level Effects:
~City (Number of levels: 15)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.93      0.36     0.30     1.66          5 1.59
sd(b1_Intercept)     0.75      0.38     0.16     1.30          3 3.16
sd(b2_Intercept)     0.50      0.50     0.10     2.06          6 1.90

~Genus (Number of levels: 18)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.46      0.42     0.01     1.02          5 1.84
sd(b1_Intercept)     0.64      0.53     0.01     1.42          4 2.12
sd(b2_Intercept)     0.41      0.41     0.01     1.00          4 3.41

~Genus:Species (Number of levels: 25)
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
sd(b0_Intercept)     0.97      0.31     0.41     1.57          5 1.67
sd(b1_Intercept)     0.56      0.30     0.12     1.09          6 1.62
sd(b2_Intercept)     0.45      0.43     0.06     1.14          3 4.71

Population-Level Effects:
                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
b0_Intercept         1.40      0.46     0.69     2.56          4 1.98
b0_t2PrecipCDD_1     0.84      0.38     0.20     1.49          4 2.45
b0_t2PrecipCDD_2     0.68      0.34     0.15     1.23          4 2.72
b0_t2PrecipCDD_3     0.96      0.48     0.21     1.89          3 3.04
b1_Intercept         0.98      0.22     0.64     1.48          6 1.47
b2_Intercept         0.86      0.08     0.76     1.04          4 1.78
...
#+begin_src R :exports results :results graphics :file ../figs/plot_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  plot(mod, ask = F)
#+end_src

#+RESULTS:
[[file:../figs/plot_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  marginal_effects(mod, effects = "AGE:CDD")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGECDD_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]

#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  marginal_effects(mod, effects = "AGE:Precip")
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_AGEPrecip_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  marginal_effects(mod, effects = "Precip:CDD", surface = T)
#+end_src

#+RESULTS:
[[file:../figs/marginal_effects_surface_PrecipCDD_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]


#+begin_src R :exports results :results graphics :file ../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0_hetero_no.png :width 800
  cond <- data.frame(Species = unique(d$Species))
  me <- marginal_effects(mod, conditions = cond, re_formula = NULL)
...
#+RESULTS:
[[file:../figs/marginal_effects_BySpecies_Genus_many_species_many_cities_many_climate_b0_hetero_no.png]]

#+begin_src R :exports results :results graphics :file ../figs/pp_check_genus_many_species_many_cities_many_climate_b0_hetero_no.png
  pp_check(mod)
#+end_src

#+RESULTS:
[[file:../figs/pp_check_genus_many_species_many_cities_many_climate_b0_hetero_no.png]]
