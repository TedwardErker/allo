...
#+begin_src R :exports results :results graphics :file ../figs/test_data_multipleSpecies_multipleLocations_PrecipCityPred.png :height 200
library(gridExtra)
pc <-   ggplot(dt, aes(x = AGE, y = DBH, color = City)) + geom_point()
pp <-   ggplot(dt, aes(x = AGE, y = DBH, color = Precip)) + geom_point()
grid.arrange(pc,pp, nrow =1)
